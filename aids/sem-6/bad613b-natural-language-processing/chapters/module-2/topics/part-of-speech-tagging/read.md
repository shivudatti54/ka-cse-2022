...
- **"book"**: Can you _book_ a _book_ on the shelf?
  - `book` as a verb: `to reserve`
  - `book` as a noun: `a physical object`
- **"back"**: The _back_ door is at the _back_ of the house, and you can _back_ into it.
...
1.  **Transition Probability (P(tag*i | tag*{i-1}))**: The probability of tag `i` appearing given the previous tag `i-1`.
