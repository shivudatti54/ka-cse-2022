...
- [Partition And Mounting](#partition-and-mounting)
...
- [Examples](#examples)
  - [Example 1: Linux Disk Partitioning Scenario](#example-1-linux-disk-partitioning-scenario)
- [Create file system](#create-file-system)
- [Mount file systems](#mount-file-systems)
- [Add to /etc/fstab for automatic mounting](#add-to-etcfstab-for-automatic-mounting)
  - [Example 2: Mounting ISO Image](#example-2-mounting-iso-image)
- [Create mount point](#create-mount-point)
- [Mount ISO image](#mount-iso-image)
- [Verify mounting](#verify-mounting)
- [Unmount when done](#unmount-when-done)
  - [Example 3: Windows Drive Letter Assignment](#example-3-windows-drive-letter-assignment)
- [Exam Tips](#exam-tips)
