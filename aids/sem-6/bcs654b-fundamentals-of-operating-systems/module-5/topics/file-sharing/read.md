...
- [Key Concepts](#key-concepts)
  - [Definition and Need for File Sharing](#definition-and-need-for-file-sharing)
  - [Simultaneous Access and Concurrency](#simultaneous-access-and-concurrency)
  - [File Locking Mechanisms](#file-locking-mechanisms)
  - [Types of File Locks](#types-of-file-locks)
  - [Semantics of File Sharing](#semantics-of-file-sharing)
  - [Issues in File Sharing](#issues-in-file-sharing)
- [Examples](#examples)
  - [Example 1: Banking Transaction](#example-1-banking-transaction)
  - [Example 2: Database Record Update](#example-2-database-record-update)
  - [Example 3: File Append Operations](#example-3-file-append-operations)
- [Exam Tips](#exam-tips)
