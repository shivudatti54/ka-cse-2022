...
- [Key Concepts](#key-concepts)
  ...
  - [2. Direct (Random) Access](#2-direct-random-access)
  - [3. Indexed Sequential Access Method (ISAM)](#3-indexed-sequential-access-method-isam)
  - [4. Memory-Mapped Access](#4-memory-mapped-access)
- [Examples](#examples)
  - [Example 1: Direct Access Calculation](#example-1-direct-access-calculation)
  - [Example 2: Indexed Sequential Search](#example-2-indexed-sequential-search)
