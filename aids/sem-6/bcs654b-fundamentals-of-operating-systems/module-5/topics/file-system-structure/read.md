...
- [3. File Operations](#3-file-operations)
  - [3.1 Primitive File Operations](#31-primitive-file-operations)
  - [3.2 Derived Operations](#32-derived-operations)
- [4. File Access Methods](#4-file-access-methods)
  - [4.1 Sequential Access](#41-sequential-access)
  - [4.2 Direct (Random) Access](#42-direct-random-access)
  - [4.3 Indexed Access](#43-indexed-access)
- [5. File Types](#5-file-types)
  - [5.1 Classification by Content](#51-classification-by-content)
  - [5.2 Classification by Extension](#52-classification-by-extension)
- [6. File Structure](#6-file-structure)
- [7. Open File Table Structure](#7-open-file-table-structure)
  - [7.1 Per-Process Open File Table](#71-per-process-open-file-table)
  - [7.2 System-Wide Open File Table](#72-system-wide-open-file-table)
