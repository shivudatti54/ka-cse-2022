...
- [Demand Paging: A Core Virtual Memory Technique](#demand-paging-a-core-virtual-memory-technique)
- [1. Introduction to Demand Paging](#1-introduction-to-demand-paging)
- [2. How Demand Paging Works](#2-how-demand-paging-works)
  - [2.1. The Page Table Entry (PTE) and Valid-Invalid Bit](#21-the-page-table-entry-pte-and-valid-invalid-bit)
  - [2.2. The Steps of a Page Fault](#22-the-steps-of-a-page-fault)
- [3. Performance of Demand Paging](#3-performance-of-demand-paging)
- [4. Copy-on-Write (COW)](#4-copy-on-write-cow)
  - [4.1. The Problem with `fork()`](#41-the-problem-with-fork)
  - [4.2. The COW Solution](#42-the-cow-solution)
- [5. Page Replacement](#5-page-replacement)
- [6. Advantages and Disadvantages](#6-advantages-and-disadvantages)
- [7. Exam Tips and Summary](#7-exam-tips-and-summary)
