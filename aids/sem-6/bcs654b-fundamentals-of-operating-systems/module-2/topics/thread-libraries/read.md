...
- [Key Concepts](#key-concepts)
  - [User-Level vs Kernel-Level Thread Libraries](#user-level-vs-kernel-level-thread-libraries)
  - [Common Thread Operations](#common-thread-operations)
  - [Multithreading Models](#multithreading-models)
- [Thread Libraries in Practice](#thread-libraries-in-practice)
  - [POSIX Threads (Pthreads)](#posix-threads-pthreads)
  - [Windows Thread API](#windows-thread-api)
  - [Java Threads](#java-threads)
- [Examples](#examples)
  - [Example 1: Basic Thread Creation (Pthreads)](#example-1-basic-thread-creation-pthreads)
  - [Example 2: Synchronization with Mutex](#example-2-synchronization-with-mutex)
