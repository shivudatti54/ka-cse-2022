...
- [Address Translation](#address-translation)
  - [Logical Address Structure](#logical-address-structure)
  - [Translation Process](#translation-process)
  - [Formula](#formula)
- [Page Table](#page-table)
  - [Page Table Entry (PTE) Contents](#page-table-entry-pte-contents)
- [Page Table Implementation](#page-table-implementation)
  - [1. Page Table Base Register (PTBR)](#1-page-table-base-register-ptbr)
  - [2. Translation Lookaside Buffer (TLB)](#2-translation-lookaside-buffer-tlb)
  - [TLB Performance](#tlb-performance)
- [Multi-Level Paging](#multi-level-paging)
  - [Problem](#problem)
  - [Solution: Hierarchical paging](#solution-hierarchical-paging)
