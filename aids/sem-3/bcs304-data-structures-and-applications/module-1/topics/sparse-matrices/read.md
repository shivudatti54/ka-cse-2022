...
- [Sparse Matrices: Theory, Representations, and Algorithms](#sparse-matrices-theory-representations-and-algorithms)
- [1. Introduction and Formal Definitions](#1-introduction-and-formal-definitions)
  - [Illustrative Example](#illustrative-example)
- [2. Motivation: Inefficiency of Dense Representation](#2-motivation-inefficiency-of-dense-representation)
  - [Memory Analysis](#memory-analysis)
  - [Numerical Demonstration](#numerical-demonstration)
  - [Computational Inefficiency](#computational-inefficiency)
- [3. Triplet Representation (Array of Triplets)](#3-triplet-representation-array-of-triplets)
  - [Definition and Formal Structure](#definition-and-formal-structure)
  - [Exemplification](#exemplification)
  - [Element Access Algorithm](#element-access-algorithm)
- [4. Compressed Sparse Row (CSR) Representation](#4-compressed-sparse-row-csr-representation)
  - [Definition](#definition)
  - [Formal Specification](#formal-specification)
  - [Access Complexity](#access-complexity)
  - [Space Complexity](#space-complexity)
- [5. Compressed Sparse Column (CSC) Representation](#5-compressed-sparse-column-csc-representation)
  - [Definition](#definition)
  - [Formal Specification](#formal-specification)
  - [Access Complexity](#access-complexity)
  - [Space Complexity](#space-complexity)
- [6. Sparse Matrix Transposition](#6-sparse-matrix-transposition)
  - [Definition](#definition)
  - [Simple Transpose Algorithm](#simple-transpose-algorithm)
  - [Fast Transpose Algorithm](#fast-transpose-algorithm)
- [7. Sparse Matrix Addition](#7-sparse-matrix-addition)
  - [Algorithm](#algorithm)
- [8. Sparse Matrix Multiplication](#8-sparse-matrix-multiplication)
  - [Algorithm](#algorithm)
- [9. Comparative Analysis of Representations](#9-comparative-analysis-of-representations)
- [10. Applications of Sparse Matrix Representations](#10-applications-of-sparse-matrix-representations)
- [MCQ (Hard Level)](#mcq-hard-level)
- [Flashcard](#flashcard)
