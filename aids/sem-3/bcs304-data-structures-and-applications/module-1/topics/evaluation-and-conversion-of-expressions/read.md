...
- [Evaluation and Conversion of Arithmetic Expressions](#evaluation-and-conversion-of-arithmetic-expressions)
- [1. Introduction and Formal Definitions](#1-introduction-and-formal-definitions)
  - [Definition 1.1: Notation](#definition-11-notation)
  - [Definition 1.2: Three Standard Notations](#definition-12-three-standard-notations)
- [2. Infix Notation: Properties and Ambiguity](#2-infix-notation-properties-and-ambiguity)
  - [Definition 2.1: Infix Notation](#definition-21-infix-notation)
  - [Problem of Ambiguity](#problem-of-ambiguity)
- [3. Prefix and Postfix Notations: Structural Clarity](#3-prefix-and-postfix-notations-structural-clarity)
  - [Definition 3.1: Prefix Notation](#definition-31-prefix-notation)
  - [Definition 3.2: Postfix Notation](#definition-32-postfix-notation)
  - [Theorem 3.1: Uniqueness Property](#theorem-31-uniqueness-property)
- [4. Operator Precedence and Associativity](#4-operator-precedence-and-associativity)
  - [Definition 4.1: Operator Precedence](#definition-41-operator-precedence)
  - [Definition 4.2: Associativity](#definition-42-associativity)
  - [Standard Precedence Table (Ascending Order)](#standard-precedence-table-ascending-order)
  - [Rule 4.1: Parentheses Override](#rule-41-parentheses-override)
  - [Associativity Examples](#associativity-examples)
- [5. Postfix Evaluation Algorithm](#5-postfix-evaluation-algorithm)
  - [Definition 5.1: Postfix Evaluation](#definition-51-postfix-evaluation)
  - [Algorithm 5.1: Evaluate Postfix](#algorithm-51-evaluate-postfix)
  - [Theorem 5.1: Correctness of Postfix Evaluation](#theorem-51-correctness-of-postfix-evaluation)
  - [Example 5.1: Evaluate `6 2 3 + * 8 2 / +`](#example-51-evaluate-6-2-3---8-2--)
- [6. Infix to Postfix Conversion Algorithm](#6-infix-to-postfix-conversion-algorithm)
  - [Algorithm 6.1: Infix to Postfix (Shunting-Yard Algorithm)](#algorithm-61-infix-to-postfix-shunting-yard-algorithm)
  - [Theorem 6.1: Stack Invariant](#theorem-61-stack-invariant)
  - [Theorem 6.2: Correctness of Infix to Postfix Conversion](#theorem-62-correctness-of-infix-to-postfix-conversion)
  - [Complexity Analysis](#complexity-analysis)
- [7. Detailed Conversion Examples](#7-detailed-conversion-examples)
  - [Example 7.1: `A + B * C - D`](#example-71-a--b--c---d)
  - [Example 7.2: `(A + B) * (C - D)`](#example-72-a--b--c---d)
  - [Example 7.3: `A ^ B ^ C` (Right-Associative)](#example-73-a--b--c-right-associative)
- [8. Prefix Notation: Evaluation](#8-prefix-notation-evaluation)
  - [Algorithm 8.1: Evaluate Prefix](#algorithm-81-evaluate-prefix)
  - [Example 8.1: Evaluate `* + 3 4 5`](#example-81-evaluate---3-4-5)
- [9. Infix to Prefix Conversion](#9-infix-to-prefix-conversion)
  - [Algorithm 9.1: Infix to Prefix](#algorithm-91-infix-to-prefix)
  - [Example 9.1: Convert `(A + B) * (C - D)` to Prefix](#example-91-convert-a--b--c---d-to-prefix)
- [10. Summary of Key Properties](#10-summary-of-key-properties)
  - [Why Postfix Dominates in Computing](#why-postfix-dominates-in-computing)
- [11. Multiple Choice Questions](#11-multiple-choice-questions)
  - [Question 1 (Conceptual - Easy)](#question-1-conceptual---easy)
  - [Question 2 (Application - Medium)](#question-2-application---medium)
  - [Question 3 (Numerical - Hard)](#question-3-numerical---hard)
  - [Question 4 (Analysis - Hard)](#question-4-analysis---hard)
- [12. Flashcard Summary](#12-flashcard-summary)
