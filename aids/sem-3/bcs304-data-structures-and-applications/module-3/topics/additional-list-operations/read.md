...
- [Additional Linked List Operations](#additional-linked-list-operations)
- [Introduction](#introduction)
- [1. Concatenation of Two Linked Lists](#1-concatenation-of-two-linked-lists)
  - [1.1 Theoretical Foundation](#11-theoretical-foundation)
  - [1.2 Algorithm and Implementation](#12-algorithm-and-implementation)
  - [1.3 Mathematical Analysis](#13-mathematical-analysis)
- [2. Reversing a Linked List In-Place](#2-reversing-a-linked-list-in-place)
  - [2.1 Theoretical Foundation](#21-theoretical-foundation)
  - [2.2 Algorithm and Implementation](#22-algorithm-and-implementation)
  - [2.3 Proof of Correctness](#23-proof-of-correctness)
  - [2.4 Visual Trace with Pointer States](#24-visual-trace-with-pointer-states)
- [3. Finding the Middle Element](#3-finding-the-middle-element)
  - [3.1 Theoretical Foundation](#31-theoretical-foundation)
  - [3.2 Implementation](#32-implementation)
- [4. Finding nth Node from the End](#4-finding-nth-node-from-the-end)
  - [4.1 Problem Formulation](#41-problem-formulation)
  - [4.2 Two-Pointer Sliding Window](#42-two-pointer-sliding-window)
- [5. Cycle Detection Using Floyd's Algorithm](#5-cycle-detection-using-floyds-algorithm)
  - [5.1 Theoretical Foundation](#51-theoretical-foundation)
  - [5.2 Implementation](#52-implementation)
  - [5.3 Complexity Analysis](#53-complexity-analysis)
- [6. Merging Two Sorted Linked Lists](#6-merging-two-sorted-linked-lists)
  - [6.1 Problem Definition](#61-problem-definition)
  - [6.2 Algorithm with Proof](#62-algorithm-with-proof)
- [7. Merge Sort for Linked Lists](#7-merge-sort-for-linked-lists)
  - [7.1 Divide and Conquer Approach](#71-divide-and-conquer-approach)
  - [7.2 Complexity Analysis](#72-complexity-analysis)
- [8. Comprehensive Comparison](#8-comprehensive-comparison)
- [9. Practice Questions](#9-practice-questions)
  ...
  - [Question 3 (Hard - Numerical)](#question-3-hard---numerical)
  - [Question 4 (Hard - Proof)](#question-4-hard---proof)
