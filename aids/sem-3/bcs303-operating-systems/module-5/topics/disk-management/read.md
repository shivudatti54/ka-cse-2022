...
- [Disk Formatting](#disk-formatting)
  - [Low-Level Formatting (Physical Formatting)](#low-level-formatting-physical-formatting)
  - [Logical Formatting (High-Level Formatting)](#logical-formatting-high-level-formatting)
- [Boot Block](#boot-block)
  - [Boot Process](#boot-process)
  - [Master Boot Record (MBR)](#master-boot-record-mbr)
  - [Windows vs UNIX Boot](#windows-vs-unix-boot)
- [Bad Block Management](#bad-block-management)
  - [Handling Bad Blocks](#handling-bad-blocks)
  - [Soft Errors vs Hard Errors](#soft-errors-vs-hard-errors)
- [Swap-Space Management](#swap-space-management)
  - [Purpose of Swap Space](#purpose-of-swap-space)
  - [Swap-Space Location](#swap-space-location)
  - [Swap-Space Management Approaches](#swap-space-management-approaches)
  - [Linux Swap](#linux-swap)
- [Create a swap partition](#create-a-swap-partition)
- [Create a swap file](#create-a-swap-file)
- [View swap usage](#view-swap-usage)
  - [Windows Swap (Page File)](#windows-swap-page-file)
- [Summary](#summary)
- [Exam Tips](#exam-tips)
