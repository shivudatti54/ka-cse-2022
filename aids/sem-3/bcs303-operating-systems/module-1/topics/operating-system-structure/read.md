...
- [1. Simple / Monolithic Structure](#1-simple--monolithic-structure)
  - [MS-DOS Structure](#ms-dos-structure)
  - [Early UNIX Structure (Monolithic Kernel)](#early-unix-structure-monolithic-kernel)
  - [Advantages and Disadvantages](#advantages-and-disadvantages)
- [2. Layered Approach](#2-layered-approach)
  - [THE Operating System (by Dijkstra, 1968)](#the-operating-system-by-dijkstra-1968)
  - [Advantages of Layered Approach](#advantages-of-layered-approach)
  - [Disadvantages of Layered Approach](#disadvantages-of-layered-approach)
- [3. Microkernel Architecture](#3-microkernel-architecture)
  - [Examples of Microkernel Systems](#examples-of-microkernel-systems)
  - [Advantages of Microkernel](#advantages-of-microkernel)
  - [Disadvantages of Microkernel](#disadvantages-of-microkernel)
- [4. Modular Approach / Loadable Kernel Modules (LKM)](#4-modular-approach--loadable-kernel-modules-lkm)
  - [Key Features](#key-features)
  - [Examples](#examples)
  - [Advantages](#advantages)
  - [Disadvantages](#disadvantages)
- [5. Hybrid Systems](#5-hybrid-systems)
  - [macOS / iOS (Apple)](#macos--ios-apple)
  - [Windows](#windows)
  - [Android](#android)
- [Comparison of OS Structures](#comparison-of-os-structures)
