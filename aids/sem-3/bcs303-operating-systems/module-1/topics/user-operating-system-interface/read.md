...
- [1. Command-Line Interface (CLI)](#1-command-line-interface-cli)
  - [How the Command Interpreter Works](#how-the-command-interpreter-works)
  - [Two Approaches to Implement Commands](#two-approaches-to-implement-commands)
  - [Types of Shells](#types-of-shells)
  - [Features of Modern Shells](#features-of-modern-shells)
- [2. Graphical User Interface (GUI)](#2-graphical-user-interface-gui)
  - [Desktop Metaphor](#desktop-metaphor)
  - [Input Devices for GUI](#input-devices-for-gui)
  - [History of GUI Development](#history-of-gui-development)
  - [GUI Components](#gui-components)
- [3. Touch-Screen Interface](#3-touch-screen-interface)
  - [Common Touch Gestures](#common-touch-gestures)
  - [Touch-Screen OS Examples](#touch-screen-os-examples)
  - [Key Differences from Traditional GUI](#key-differences-from-traditional-gui)
- [4. Comparison: CLI vs GUI](#4-comparison-cli-vs-gui)
  - [When to Use What?](#when-to-use-what)
- [5. System Calls as the Programmatic Interface](#5-system-calls-as-the-programmatic-interface)
  - [How Programs Use System Calls](#how-programs-use-system-calls)
  - [The Role of the System Call Interface](#the-role-of-the-system-call-interface)
- [Summary](#summary)
- [Exam Tips](#exam-tips)
