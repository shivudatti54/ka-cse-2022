...
- [Allocation of Frames in Operating Systems](#allocation-of-frames-in-operating-systems)
- [Introduction](#introduction)
- [Core Concepts of Frame Allocation](#core-concepts-of-frame-allocation)
  - [1. Fixed Allocation Schemes](#1-fixed-allocation-schemes)
  - [2. Priority Allocation](#2-priority-allocation)
  - [3. Variable (Dynamic) Global vs. Local Allocation](#3-variable-dynamic-global-vs-local-allocation)
