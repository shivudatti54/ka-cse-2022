...
- [Critical Section](#critical-section)
  - [Structure of Process](#structure-of-process)
- [Requirements for Solution](#requirements-for-solution)
  - [1. Mutual Exclusion](#1-mutual-exclusion)
  - [2. Progress](#2-progress)
  - [3. Bounded Waiting](#3-bounded-waiting)
- [Software Solutions](#software-solutions)
  - [Peterson's Solution (2 processes)](#petersons-solution-2-processes)
  - [Bakery Algorithm (n processes)](#bakery-algorithm-n-processes)
