...
- [Introduction to Deadlock Detection](#introduction-to-deadlock-detection)
- [The Deadlock Detection Algorithm](#the-deadlock-detection-algorithm)
  - [Wait-For Graph (Single Instance)](#wait-for-graph-single-instance)
  - [Detection Algorithm for Multiple Instances](#detection-algorithm-for-multiple-instances)
- [Example of Deadlock Detection](#example-of-deadlock-detection)
- [When to Invoke Detection?](#when-to-invoke-detection)
...
- [Comparison of Deadlock Handling Methods](#comparison-of-deadlock-handling-methods)
