...
- [Process Synchronization: Introduction](#process-synchronization-introduction)
- [1. Background: Why Synchronization is Needed](#1-background-why-synchronization-is-needed)
- [2. The Producer-Consumer Problem: Motivation](#2-the-producer-consumer-problem-motivation)
  - [2.1 Bounded Buffer Setup](#21-bounded-buffer-setup)
  - [2.2 Producer Code](#22-producer-code)
  - [2.3 Consumer Code](#23-consumer-code)
  - [2.4 The Problem](#24-the-problem)
- [3. Race Condition](#3-race-condition)
  - [3.1 Why count++ and count-- Are Not Atomic](#31-why-count-and-count---are-not-atomic)
  - [3.2 The Classic Race Condition Example](#32-the-classic-race-condition-example)
  - [3.3 Key Insight](#33-key-insight)
- [4. The Need for Atomic Operations](#4-the-need-for-atomic-operations)
  - [4.1 Why Atomicity Matters](#41-why-atomicity-matters)
  - [4.2 What Needs Protection](#42-what-needs-protection)
- [5. The Critical Section Problem: Formal Definition](#5-the-critical-section-problem-formal-definition)
  - [5.1 Structure of a Process](#51-structure-of-a-process)
  - [5.2 Three Requirements for a Solution](#52-three-requirements-for-a-solution)
- [6. Overview of Synchronization Mechanisms](#6-overview-of-synchronization-mechanisms)
  - [6.1 Software-Based Solutions](#61-software-based-solutions)
  - [6.2 Hardware-Based Solutions](#62-hardware-based-solutions)
  - [6.3 OS-Provided Synchronization Tools](#63-os-provided-synchronization-tools)
  - [6.4 Progression of Topics in Module 3](#64-progression-of-topics-in-module-3)
- [7. Cooperating Processes: Benefits and Challenges](#7-cooperating-processes-benefits-and-challenges)
  - [7.1 Why Allow Cooperation?](#71-why-allow-cooperation)
  - [7.2 Challenges of Cooperation](#72-challenges-of-cooperation)
- [8. Another Race Condition Example: Shared Linked List](#8-another-race-condition-example-shared-linked-list)
- [9. Formal Definition of Race Condition](#9-formal-definition-of-race-condition)
