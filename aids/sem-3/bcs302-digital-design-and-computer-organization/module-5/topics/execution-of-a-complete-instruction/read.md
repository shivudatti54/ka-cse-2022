...
- [Execution of a Complete Instruction](#execution-of-a-complete-instruction)
- [Overview](#overview)
- [The Instruction Cycle](#the-instruction-cycle)
  - [Phases of the Instruction Cycle](#phases-of-the-instruction-cycle)
- [Execution Units and Datapath](#execution-units-and-datapath)
...
- [Timing and Performance Analysis](#timing-and-performance-analysis)
  - [Clock Cycle Determination](#clock-cycle-determination)
  - [Cycles Per Instruction (CPI)](#cycles-per-instruction-cpi)
  - [Pipelining Performance](#pipelining-performance)
- [Advanced Execution Concepts](#advanced-execution-concepts)
  - [Instruction-Level Parallelism (ILP)](#instruction-level-parallelism-ilp)
  - [Single-Cycle vs Multi-Cycle Implementation](#single-cycle-vs-multi-cycle-implementation)
- [Example: Complete Instruction Execution Trace](#example-complete-instruction-execution-trace)
  - [R-Type Instruction (ADD)](#r-type-instruction-add)
  - [Load Instruction (LW)](#load-instruction-lw)
  - [Store Instruction (SW)](#store-instruction-sw)
