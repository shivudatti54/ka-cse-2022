...
- [1. Introduction to I/O Data Transfer Mechanisms](#1-introduction-to-io-data-transfer-mechanisms)
  - [1.1 Programmed I/O (Polling)](#11-programmed-io-polling)
  - [1.2 Interrupt-Driven I/O](#12-interrupt-driven-io)
- [2. Direct Memory Access (DMA): Definition and Motivation](#2-direct-memory-access-dma-definition-and-motivation)
  - [2.1 Fundamental Principle](#21-fundamental-principle)
  - [2.2 Key Characteristics](#22-key-characteristics)
- [3. DMA Controller: Architecture and Registers](#3-dma-controller-architecture-and-registers)
  - [3.1 Internal Register Structure](#31-internal-register-structure)
  - [3.2 DMAC Architecture Diagram](#32-dmac-architecture-diagram)
- [4. DMA Transfer Modes](#4-dma-transfer-modes)
  - [4.1 Burst Mode (Block Transfer Mode)](#41-burst-mode-block-transfer-mode)
  - [4.2 Cycle Stealing Mode](#42-cycle-stealing-mode)
  - [4.3 Transparent Mode](#43-transparent-mode)
  - [4.4 Demand Transfer Mode](#44-demand-transfer-mode)
- [5. Bus Arbitration and Transfer Protocol](#5-bus-arbitration-and-transfer-protocol)
  - [5.1 Bus Arbitration Sequence](#51-bus-arbitration-sequence)
  - [5.2 Detailed Transfer Steps](#52-detailed-transfer-steps)
  - [5.3 Priority Schemes](#53-priority-schemes)
- [6. Performance Analysis: Quantitative Comparison](#6-performance-analysis-quantitative-comparison)
  - [6.1 Transfer Time Calculation](#61-transfer-time-calculation)
  - [6.2 Bus Utilization Analysis](#62-bus-utilization-analysis)
...
- [8. Assessment Questions](#8-assessment-questions)
  - [Multiple Choice Questions (Hard Level)](#multiple-choice-questions-hard-level)
