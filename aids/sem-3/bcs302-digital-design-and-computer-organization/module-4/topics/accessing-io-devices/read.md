...
- [2. Classification of I/O Devices](#2-classification-of-io-devices)
  - [2.1 Input Devices](#21-input-devices)
  - [2.2 Output Devices](#22-output-devices)
  - [2.3 Storage Devices](#23-storage-devices)
  - [2.4 Communication Devices](#24-communication-devices)
- [3. Fundamental Differences: I/O vs Memory Access](#3-fundamental-differences-io-vs-memory-access)
- [4. I/O Interface Architecture](#4-io-interface-architecture)
  - [4.1 Interface Components](#41-interface-components)
  - [4.2 Handshaking Protocol](#42-handshaking-protocol)
- [5. I/O Addressing Schemes](#5-io-addressing-schemes)
  - [5.1 Memory-Mapped I/O (MMIO)](#51-memory-mapped-io-mmio)
  - [5.2 Isolated I/O (Port-Mapped I/O)](#52-isolated-io-port-mapped-io)
- [6. Methods of I/O Access](#6-methods-of-io-access)
  - [6.1 Programmed I/O (Polling)](#61-programmed-io-polling)
  - [6.2 Interrupt-Driven I/O](#62-interrupt-driven-io)
  - [6.3 Direct Memory Access (DMA)](#63-direct-memory-access-dma)
