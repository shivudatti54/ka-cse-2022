...
- [Speed, Size and Cost of Memory Systems](#speed-size-and-cost-of-memory-systems)
- [Introduction](#introduction)
- [Theoretical Foundation: The Speed-Size-Cost Trade-off](#theoretical-foundation-the-speed-size-cost-trade-off)
  - [Physical Constraints](#physical-constraints)
  - [Economic Constraints](#economic-constraints)
  - [Quantitative Comparison of Memory Technologies](#quantitative-comparison-of-memory-technologies)
- [SRAM: Static Random Access Memory](#sram-static-random-access-memory)
  - [Circuit Structure and Operation](#circuit-structure-and-operation)
  - [Applications](#applications)
- [DRAM: Dynamic Random Access Memory](#dram-dynamic-random-access-memory)
  - [Circuit Structure and Operation](#circuit-structure-and-operation)
  - [Performance Implications](#performance-implications)
- [The Memory Hierarchy: Quantitative Analysis](#the-memory-hierarchy-quantitative-analysis)
  - [Quantitative Hierarchy Parameters](#quantitative-hierarchy-parameters)
- [Principle of Locality: Theoretical Basis](#principle-of-locality-theoretical-basis)
  - [Temporal Locality](#temporal-locality)
  - [Spatial Locality](#spatial-locality)
- [Cache Memory: Performance Modeling](#cache-memory-performance-modeling)
  - [Hit Rate and Miss Rate](#hit-rate-and-miss-rate)
  - [Average Memory Access Time (AMAT)](#average-memory-access-time-amat)
  - [Multi-Level AMAT](#multi-level-amat)
- [Cost-Performance Optimization](#cost-performance-optimization)
  - [Effective Cost Per Bit](#effective-cost-per-bit)
  - [Design Optimization Problem](#design-optimization-problem)
- [Key Theoretical Takeaways](#key-theoretical-takeaways)
