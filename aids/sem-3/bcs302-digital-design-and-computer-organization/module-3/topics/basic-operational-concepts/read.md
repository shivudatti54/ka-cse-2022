...
- [Basic Operational Concepts in Computer Organization](#basic-operational-concepts-in-computer-organization)
- [Introduction](#introduction)
- [1. The Instruction Cycle: Formal Specification](#1-the-instruction-cycle-formal-specification)
  - [1.1 Fetch Cycle (Instruction Fetch)](#11-fetch-cycle-instruction-fetch)
  - [1.2 Decode Cycle (Instruction Decode)](#12-decode-cycle-instruction-decode)
  - [1.3 Execute Cycle (Instruction Execute)](#13-execute-cycle-instruction-execute)
- [2. CPU Registers and Datapath Interface](#2-cpu-registers-and-datapath-interface)
- [3. Detailed Execution Examples with RTL Notation](#3-detailed-execution-examples-with-rtl-notation)
  - [Example 1: Register-to-Register ADD Instruction](#example-1-register-to-register-add-instruction)
  - [Example 2: Memory Reference Instruction (LOAD)](#example-2-memory-reference-instruction-load)
  - [Example 3: Conditional Branch Instruction](#example-3-conditional-branch-instruction)
- [4. Control Unit: Signal Generation and Timing](#4-control-unit-signal-generation-and-timing)
  - [4.1 Hardwired Control](#41-hardwired-control)
  - [4.2 Microprogrammed Control](#42-microprogrammed-control)
- [5. Quantitative Performance Analysis](#5-quantitative-performance-analysis)
  - [5.1 Clock Cycles Per Instruction (CPI)](#51-clock-cycles-per-instruction-cpi)
  - [5.2 Example Calculation](#52-example-calculation)
  - [5.3 Execution Time](#53-execution-time)
- [6. Interrupt Handling and Control Transfer](#6-interrupt-handling-and-control-transfer)
- [7. Advanced Considerations](#7-advanced-considerations)
  - [7.1 Instruction Pipelining](#71-instruction-pipelining)
  - [7.2 Bus Architecture and Memory Access](#72-bus-architecture-and-memory-access)
- [Summary](#summary)
