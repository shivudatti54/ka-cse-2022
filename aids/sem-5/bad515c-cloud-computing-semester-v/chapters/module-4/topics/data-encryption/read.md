...
The shared responsibility model, central to cloud security, dictates that while the cloud provider is responsible for securing the underlying infrastructure (security *of* the cloud), the customer is responsible for securing their data within that infrastructure (security *in* the cloud). Data encryption is a primary mechanism through which customers fulfill this responsibility.
...
*   **Shared Responsibility Model:** Always frame your answers within this model. The provider secures the infrastructure, the customer is responsible for encrypting their data *in* that infrastructure.
