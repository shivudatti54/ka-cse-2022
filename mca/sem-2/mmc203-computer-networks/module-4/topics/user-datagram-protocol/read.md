...
- [Key Concepts](#key-concepts)
  ...
  - [Well-Known UDP Ports](#well-known-udp-ports)
- [Examples](#examples)
  - [Example 1: UDP Header Analysis](#example-1-udp-header-analysis)
  - [Example 2: Calculating UDP Length Field](#example-2-calculating-udp-length-field)
  - [Example 3: Throughput Comparison](#example-3-throughput-comparison)
- [Exam Tips](#exam-tips)
