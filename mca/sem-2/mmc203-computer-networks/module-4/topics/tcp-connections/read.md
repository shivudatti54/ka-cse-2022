...
- [Key Concepts](#key-concepts)
  ...
  - [Three-Way Handshake (Connection Establishment)](#three-way-handshake-connection-establishment)
  - [Four-Way Handshake (Connection Termination)](#four-way-handshake-connection-termination)
  - [TCP States](#tcp-states)
  - [Socket Programming](#socket-programming)
  - [Connection Parameters and Options](#connection-parameters-and-options)
- [Examples](#examples)
  - [Example 1: Tracing a Three-Way Handshake](#example-1-tracing-a-three-way-handshake)
  - [Example 2: Server Socket Programming](#example-2-server-socket-programming)
  - [Example 3: Client Socket Programming](#example-3-client-socket-programming)
- [Exam Tips](#exam-tips)
