...
- [Key Concepts](#key-concepts)
  ...
  - [Sequence Number and Acknowledgment](#sequence-number-and-acknowledgment)
  - [Control Flags](#control-flags)
  - [Maximum Segment Size (MSS)](#maximum-segment-size-mss)
- [Examples](#examples)
  - [Example 1: Three-Way Handshake](#example-1-three-way-handshake)
  - [Example 2: Data Transfer with Acknowledgment](#example-2-data-transfer-with-acknowledgment)
  - [Example 3: Segment with Multiple Flags](#example-3-segment-with-multiple-flags)
- [Exam Tips](#exam-tips)
