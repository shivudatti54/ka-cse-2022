...
- [Error Control in Data Communication](#error-control-in-data-communication)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [Types of Errors](#types-of-errors)
  - [Error Detection Techniques](#error-detection-techniques)
  - [Error Correction Techniques](#error-correction-techniques)
  - [Automatic Repeat Request (ARQ)](#automatic-repeat-request-arq)
- [Examples](#examples)
  - [Example 1: Parity Check Detection](#example-1-parity-check-detection)
  - [Example 2: CRC Error Detection](#example-2-crc-error-detection)
  - [Example 3: Hamming Code Correction](#example-3-hamming-code-correction)
- [Exam Tips](#exam-tips)
