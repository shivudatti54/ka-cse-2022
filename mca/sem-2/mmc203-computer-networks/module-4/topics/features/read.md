...
- [Features of Transmission Control Protocol (TCP)](#features-of-transmission-control-protocol-tcp)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [1. Reliability and Error Control](#1-reliability-and-error-control)
  - [2. Flow Control](#2-flow-control)
  - [3. Congestion Control](#3-congestion-control)
  - [4. Connection-Oriented Communication](#4-connection-oriented-communication)
  - [5. Full-Duplex Communication](#5-full-duplex-communication)
  - [6. Byte Stream Service](#6-byte-stream-service)
  - [7. Port Numbers and Socket Pairs](#7-port-numbers-and-socket-pairs)
  - [8. TCP Header Structure](#8-tcp-header-structure)
- [Examples](#examples)
  - [Example 1: Three-Way Handshake Analysis](#example-1-three-way-handshake-analysis)
  - [Example 2: Sliding Window in Action](#example-2-sliding-window-in-action)
  - [Example 3: Congestion Control Demonstration](#example-3-congestion-control-demonstration)
- [Exam Tips](#exam-tips)
