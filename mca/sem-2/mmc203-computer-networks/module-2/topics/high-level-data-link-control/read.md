...
- [Key Concepts](#key-concepts)
  - [HDLC Protocol Architecture](#hdlc-protocol-architecture)
  - [HDLC Frame Structure](#hdlc-frame-structure)
  - [Frame Types](#frame-types)
  - [HDLC Operational Modes](#hdlc-operational-modes)
  - [Error Control and Flow Control](#error-control-and-flow-control)
  - [Bit Stuffing](#bit-stuffing)
- [Examples](#examples)
  - [Example 1: Frame Construction](#example-1-frame-construction)
  - [Example 2: Bit Stuffing](#example-2-bit-stuffing)
  - [Example 3: Error Detection Using CRC](#example-3-error-detection-using-crc)
- [Exam Tips](#exam-tips)
