...
- [Introduction to Data Link Layer: Error Detection and Correction](#introduction-to-data-link-layer-error-detection-and-correction)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [Position of Data Link Layer in OSI Model](#position-of-data-link-layer-in-osi-model)
  - [Services Provided by Data Link Layer](#services-provided-by-data-link-layer)
  - [Types of Errors in Data Transmission](#types-of-errors-in-data-transmission)
  - [Sub-layers of Data Link Layer](#sub-layers-of-data-link-layer)
...
- [Error Correction Methods](#error-correction-methods)
  ...
  - [Difference Between Error Detection and Error Correction](#difference-between-error-detection-and-error-correction)
- [Examples](#examples)
  - [Example 1: Simple Parity Check](#example-1-simple-parity-check)
  - [Example 2: CRC Calculation](#example-2-crc-calculation)
  - [Example 3: Hamming Code](#example-3-hamming-code)
...
For semester exams, keep these important points in mind:
