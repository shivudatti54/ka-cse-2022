...
- [Connectionless and Connection-Oriented Services](#connectionless-and-connection-oriented-services)
...
- [Key Concepts](#key-concepts)
  ...
  - [Comparison: Connectionless vs Connection-Oriented](#comparison-connectionless-vs-connection-oriented)
- [Examples](#examples)
  - [Example 1: UDP in DNS Resolution](#example-1-udp-in-dns-resolution)
  - [Example 2: TCP for File Transfer](#example-2-tcp-for-file-transfer)
  - [Example 3: Real-Time Streaming Trade-off](#example-3-real-time-streaming-trade-off)
- [Exam Tips](#exam-tips)
