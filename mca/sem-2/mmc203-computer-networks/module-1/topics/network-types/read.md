...
- [Key Concepts](#key-concepts)
  ...
  - [Comparison of Network Types](#comparison-of-network-types)
- [Examples](#examples)
  - [Example 1: Designing a Small Office Network](#example-1-designing-a-small-office-network)
  - [Example 2: University Campus Network Design](#example-2-university-campus-network-design)
  - [Example 3: Comparing WAN and LAN for Enterprise](#example-3-comparing-wan-and-lan-for-enterprise)
- [Exam Tips](#exam-tips)
