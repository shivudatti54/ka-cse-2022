...
- [Guided Media in Computer Networks](#guided-media-in-computer-networks)
...
- [Examples](#examples)
  - [Example 1: Comparing Cable Types for a LAN Installation](#example-1-comparing-cable-types-for-a-lan-installation)
  - [Example 2: Calculating Maximum Network Segments](#example-2-calculating-maximum-network-segments)
  - [Example 3: Fiber Optic Link Budget Calculation](#example-3-fiber-optic-link-budget-calculation)
- [Exam Tips](#exam-tips)
