...
- [Examples](#examples)
  - [Example 1: HTTP Request Flow Through Layers](#example-1-http-request-flow-through-layers)
  - [Example 2: Understanding PDU Names](#example-2-understanding-pdu-names)
  - [Example 3: Router Operation Across Layers](#example-3-router-operation-across-layers)
- [Exam Tips](#exam-tips)
