...
- [Key Concepts](#key-concepts)
  - [Architecture of LSR](#architecture-of-lsr)
  ...
  - [Types of LSR](#types-of-lsr)
  - [Penultimate Hop Popping](#penultimate-hop-popping)
- [Examples](#examples)
  - [Example 1: Basic Label Switching Operation](#example-1-basic-label-switching-operation)
  - [Example 2: Label Distribution Process](#example-2-label-distribution-process)
  - [Example 3: Traffic Engineering with LSR](#example-3-traffic-engineering-with-lsr)
- [Exam Tips](#exam-tips)
