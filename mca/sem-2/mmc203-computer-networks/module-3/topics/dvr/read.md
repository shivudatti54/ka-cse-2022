...
- [Key Concepts](#key-concepts)
  ...
  - [Routing Update Process](#routing-update-process)
  - [Count-to-Infinity Problem](#count-to-infinity-problem)
  - [RIP (Routing Information Protocol)](#rip-routing-information-protocol)
- [Examples](#examples)
  - [Example 1: Initial Routing Table Setup](#example-1-initial-routing-table-setup)
  - [Example 2: Routing Update Calculation](#example-2-routing-update-calculation)
  - [Example 3: Split Horizon Demonstration](#example-3-split-horizon-demonstration)
- [Exam Tips](#exam-tips)
