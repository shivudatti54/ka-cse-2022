...
- [Key Concepts](#key-concepts)
  ...
  - [Comparison with Distance Vector and Link State Routing](#comparison-with-distance-vector-and-link-state-routing)
  - [BGP: The Path Vector Protocol](#bgp-the-path-vector-protocol)
...
- [Examples](#examples)
  - [Example 1: AS Path Loop Prevention](#example-1-as-path-loop-prevention)
  - [Example 2: BGP Route Selection with LOCAL-PREF](#example-2-bgp-route-selection-with-local-pref)
  - [Example 3: Multi-Exit Discriminator (MED) Usage](#example-3-multi-exit-discriminator-med-usage)
- [Real-World Applications](#real-world-applications)
  - [Internet Backbone Routing](#internet-backbone-routing)
  - [Multi-Homing for Redundancy](#multi-homing-for-redundancy)
