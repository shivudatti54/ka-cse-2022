...
- [Key Concepts](#key-concepts)
  ...
  - [BGP Route Selection Process](#bgp-route-selection-process)
  - [BGP States](#bgp-states)
- [Examples](#examples)
  - [Example 1: Basic BGP Configuration](#example-1-basic-bgp-configuration)
  - [Example 2: BGP Route Selection with Local Preference](#example-2-bgp-route-selection-with-local-preference)
  - [Example 3: AS_Path Prepending for Inbound Traffic Engineering](#example-3-aspath-prepending-for-inbound-traffic-engineering)
- [Exam Tips](#exam-tips)
