...
- [Key Concepts](#key-concepts)
  ...
  - [FTP Connection Modes](#ftp-connection-modes)
  - [FTP Commands](#ftp-commands)
  - [FTP Responses](#ftp-responses)
  - [FTP Modes](#ftp-modes)
  - [Anonymous FTP](#anonymous-ftp)
  - [FTPS and SFTP](#ftps-and-sftp)
- [Examples](#examples)
  - [Example 1: FTP Session Walkthrough](#example-1-ftp-session-walkthrough)
  - [Example 2: FTP Mode Selection Problem](#example-2-ftp-mode-selection-problem)
  - [Example 3: Troubleshooting FTP Connection](#example-3-troubleshooting-ftp-connection)
- [Exam Tips](#exam-tips)
