...
- [World Wide Web and HTTP](#world-wide-web-and-http)
...
- [Examples](#examples)
  - [Example 1: Analyzing a Complete HTTP Request-Response](#example-1-analyzing-a-complete-http-request-response)
  - [Example 2: Form Submission Using POST](#example-2-form-submission-using-post)
  - [Example 3: Conditional GET Request](#example-3-conditional-get-request)
- [Exam Tips](#exam-tips)
