...
- [1. Introduction and Fundamental Concepts](#1-introduction-and-fundamental-concepts)
  ...
  - [1.2 Uniform Hashing Assumption](#12-uniform-hashing-assumption)
- [2. Hash Function Design](#2-hash-function-design)
  - [2.1 Division Method (Modular Arithmetic)](#21-division-method-modular-arithmetic)
  - [2.2 Mid-Square Method](#22-mid-square-method)
  - [2.3 Folding Method](#23-folding-method)
  - [2.4 Digit Extraction Method](#24-digit-extraction-method)
  - [2.5 Properties of an Ideal Hash Function](#25-properties-of-an-ideal-hash-function)
- [3. Collision Resolution Techniques](#3-collision-resolution-techniques)
  - [3.1 Separate Chaining (Open Hashing)](#31-separate-chaining-open-hashing)
  - [3.2 Open Addressing (Closed Hashing)](#32-open-addressing-closed-hashing)
  - [3.3 Comparison of Collision Resolution Techniques](#33-comparison-of-collision-resolution-techniques)
- [4. Performance Analysis](#4-performance-analysis)
  - [4.1 Load Factor Impact](#41-load-factor-impact)
  - [4.2 Expected Probe Sequences](#42-expected-probe-sequences)
  - [4.3 Rehashing Strategy](#43-rehashing-strategy)
- [5. C Implementation](#5-c-implementation)
- [6. Numerical Problems](#6-numerical-problems)
  - [Problem 1](#problem-1)
  - [Problem 2](#problem-2)
