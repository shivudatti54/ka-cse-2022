...
- [Forests in Graph Theory and Data Structures](#forests-in-graph-theory-and-data-structures)
- [1. Introduction](#1-introduction)
- [2. Formal Definition and Mathematical Foundation](#2-formal-definition-and-mathematical-foundation)
  - [2.1 Graph-Theoretic Definition](#21-graph-theoretic-definition)
  - [2.2 Relationship to Trees](#22-relationship-to-trees)
  - [2.3 Fundamental Properties and Theorems](#23-fundamental-properties-and-theorems)
- [3. Representation of Forests](#3-representation-of-forests)
  - [3.1 Parent Pointer Representation](#31-parent-pointer-representation)
  - [3.2 Left-Child Right-Sibling Representation](#32-left-child-right-sibling-representation)
  - [3.3 Sequential (Array) Representation](#33-sequential-array-representation)
- [4. Binary Tree Representation of General Trees](#4-binary-tree-representation-of-general-trees)
  - [4.1 Transformation Algorithm](#41-transformation-algorithm)
  - [4.2 Example Transformation](#42-example-transformation)
- [5. Operations on Forests](#5-operations-on-forests)
  - [5.1 Fundamental Operations](#51-fundamental-operations)
  - [5.2 Forest Traversal Algorithms](#52-forest-traversal-algorithms)
- [6. Applications](#6-applications)
  - [6.1 Disjoint Set Union (Union-Find)](#61-disjoint-set-union-union-find)
  - [6.2 Spanning Forests in Graph Traversal](#62-spanning-forests-in-graph-traversal)
  - [6.3 Minimum Spanning Tree Algorithms](#63-minimum-spanning-tree-algorithms)
- [7. Solved Examples](#7-solved-examples)
  - [Example 1: Edge Count in Forest](#example-1-edge-count-in-forest)
  - [Example 2: LCRS Transformation](#example-2-lcrs-transformation)
