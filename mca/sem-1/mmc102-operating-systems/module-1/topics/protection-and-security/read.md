...
- [Protection and Security in Operating Systems](#protection-and-security-in-operating-systems)
- [Introduction](#introduction)
- [Core Concepts](#core-concepts)
  - [1. The Principle of Least Privilege](#1-the-principle-of-least-privilege)
  - [2. Domain of Protection](#2-domain-of-protection)
  - [3. Access Matrix Model](#3-access-matrix-model)
  - [4. Authentication](#4-authentication)
  - [5. Security Threats (A Brief Overview)](#5-security-threats-a-brief-overview)
