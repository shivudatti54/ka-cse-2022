...
- [Operating System Generation (SYSGEN)](#operating-system-generation-sysgen)
- [Introduction](#introduction)
- [Why is SYSGEN Needed?](#why-is-sysgen-needed)
- [Information Required by SYSGEN](#information-required-by-sysgen)
  - [1. CPU Information](#1-cpu-information)
  - [2. Memory Information](#2-memory-information)
  - [3. Device Information](#3-device-information)
  - [4. OS Options](#4-os-options)
- [Approaches to SYSGEN](#approaches-to-sysgen)
  - [Approach 1: Recompile the Kernel](#approach-1-recompile-the-kernel)
  - [Approach 2: Pre-compiled with Table-Driven Selection](#approach-2-pre-compiled-with-table-driven-selection)
  - [Approach 3: Fully Modular (Loadable Kernel Modules)](#approach-3-fully-modular-loadable-kernel-modules)
  - [Comparison of Approaches](#comparison-of-approaches)
- [Linux Kernel Configuration](#linux-kernel-configuration)
  - [Configuration Tools](#configuration-tools)
  - [Configuration File](#configuration-file)
- [.config file (partial example)](#config-file-partial-example)
