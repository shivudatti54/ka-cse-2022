...
- [Domain of Protection](#domain-of-protection)
  - [What is a Protection Domain?](#what-is-a-protection-domain)
  - [Process-Domain Association](#process-domain-association)
- [Access Matrix Model](#access-matrix-model)
  - [Operations on the Access Matrix](#operations-on-the-access-matrix)
- [Implementation of the Access Matrix](#implementation-of-the-access-matrix)
  - [1. Global Table](#1-global-table)
  - [2. Access Lists for Objects (ACL)](#2-access-lists-for-objects-acl)
  - [3. Capability Lists for Domains](#3-capability-lists-for-domains)
  - [4. Lock-Key Mechanism](#4-lock-key-mechanism)
- [Comparison: Access List vs Capability List](#comparison-access-list-vs-capability-list)
- [Revocation of Access Rights](#revocation-of-access-rights)
  - [Revocation with Different Implementations](#revocation-with-different-implementations)
  - [Capability Revocation Techniques](#capability-revocation-techniques)
