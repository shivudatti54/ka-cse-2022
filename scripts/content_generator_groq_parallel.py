#!/usr/bin/env python3
"""
VTU Content Generator - Groq Parallel
...
TEMPERATURE = 0.3
DEFAULT_WORKERS = 10
PROGRESS_FILE = "groq_parallel_progress.json"
...
def call_api_with_heartbeat(messages: list, topic_desc: str) -> dict:
    """Call Groq API with timeout and heartbeat monitoring."""
    payload = json.dumps({
...
# ── Main ───────────────────────────────────────────────────────────────────
def main():
    parser = argparse.ArgumentParser(description="VTU Content Generator - Groq Parallel")
