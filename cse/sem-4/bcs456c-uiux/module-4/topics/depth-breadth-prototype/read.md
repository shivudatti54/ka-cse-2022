...
- [Depth and Breadth of a Prototype](#depth-and-breadth-of-a-prototype)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [Understanding Prototype Depth](#understanding-prototype-depth)
  - [Understanding Prototype Breadth](#understanding-prototype-breadth)
  - [The Depth-Breadth Trade-off](#the-depth-breadth-trade-off)
  - [Types of Prototypes Based on Depth and Breadth](#types-of-prototypes-based-on-depth-and-breadth)
  - [Factors Influencing Depth-Breadth Decisions](#factors-influencing-depth-breadth-decisions)
- [Examples](#examples)
  - [Example 1: E-Commerce Mobile App Prototype](#example-1-e-commerce-mobile-app-prototype)
  - [Example 2: Healthcare Dashboard Design](#example-2-healthcare-dashboard-design)
  - [Example 3: Banking Application Login Flow](#example-3-banking-application-login-flow)
- [Exam Tips](#exam-tips)
