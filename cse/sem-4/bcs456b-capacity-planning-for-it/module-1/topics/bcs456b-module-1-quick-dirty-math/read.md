...
- [Quick and Dirty Math in IT Capacity Planning](#quick-and-dirty-math-in-it-capacity-planning)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [1. The Power of 10 Approach](#1-the-power-of-10-approach)
  - [2. Little's Law and Simple Queuing Estimates](#2-littles-law-and-simple-queuing-estimates)
  - [3. Utilization and Response Time Relationships](#3-utilization-and-response-time-relationships)
  - [4. 80/20 Rule for Capacity Estimation](#4-8020-rule-for-capacity-estimation)
  - [5. Linear Extrapolation and Scaling Factors](#5-linear-extrapolation-and-scaling-factors)
  - [6. Rules of Thumb for Common IT Components](#6-rules-of-thumb-for-common-it-components)
  - [7. The "Three Numbers" Quick Test](#7-the-three-numbers-quick-test)
- [Examples](#examples)
  - [Example 1: Quick Web Server Capacity Estimate](#example-1-quick-web-server-capacity-estimate)
  - [Example 2: Database Connection Pool Sizing](#example-2-database-connection-pool-sizing)
  - [Example 3: Storage Capacity Quick Estimate](#example-3-storage-capacity-quick-estimate)
- [Exam Tips](#exam-tips)
