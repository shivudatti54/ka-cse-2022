...
- [Key Concepts](#key-concepts)
  ...
  - [Capacity Planning in Virtualized and Cloud Environments](#capacity-planning-in-virtualized-and-cloud-environments)
- [Examples](#examples)
  - [Example 1: Server Virtualization Capacity Planning](#example-1-server-virtualization-capacity-planning)
  - [Example 2: Cloud Auto-Scaling Configuration](#example-2-cloud-auto-scaling-configuration)
  - [Example 3: Hybrid Cloud Capacity Planning](#example-3-hybrid-cloud-capacity-planning)
- [Exam Tips](#exam-tips)
