...
- [Example Sandstone: ARM Firmware Implementation Framework](#example-sandstone-arm-firmware-implementation-framework)
...
- [Key Concepts](#key-concepts)
  ...
  - [Interrupt Latency Considerations](#interrupt-latency-considerations)
  - [Vector Table Design](#vector-table-design)
  - [IRQ and FIQ Exceptions](#irq-and-fiq-exceptions)
- [Examples](#examples)
  - [Example 1: Vector Table Configuration](#example-1-vector-table-configuration)
  - [Example 2: Interrupt Priority Assignment](#example-2-interrupt-priority-assignment)
  - [Example 3: Exception Handler Implementation](#example-3-exception-handler-implementation)
- [Exam Tips](#exam-tips)
