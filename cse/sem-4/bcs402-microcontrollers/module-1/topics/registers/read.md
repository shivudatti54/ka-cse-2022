...
- [Current Program Status Register (CPSR) in ARM Architecture](#current-program-status-register-cpsr-in-arm-architecture)
- [Introduction](#introduction)
- [Theoretical Framework](#theoretical-framework)
  - [1. CPSR Architecture and Bit Field Organization](#1-cpsr-architecture-and-bit-field-organization)
  - [2. Condition Flags: Detailed Analysis](#2-condition-flags-detailed-analysis)
  - [3. Processor Control Bits](#3-processor-control-bits)
  - [4. Saved Program Status Register (SPSR)](#4-saved-program-status-register-spsr)
  - [5. CPSR Access Instructions](#5-cpsr-access-instructions)
  - [6. Conditional Execution in ARM](#6-conditional-execution-in-arm)
- [Summary](#summary)
