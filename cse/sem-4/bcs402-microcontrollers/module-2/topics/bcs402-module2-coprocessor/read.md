...
- [Coprocessor Instructions in ARM Microcontrollers](#coprocessor-instructions-in-arm-microcontrollers)
- [Introduction](#introduction)
- [1. Coprocessor Architecture Fundamentals](#1-coprocessor-architecture-fundamentals)
  - [1.1 Architectural Overview](#11-architectural-overview)
  - [1.2 ARM Coprocessor Numbering Scheme](#12-arm-coprocessor-numbering-scheme)
  - [1.3 CPU-Coprocessor Communication Protocol](#13-cpu-coprocessor-communication-protocol)
- [2. Coprocessor Instruction Set Architecture](#2-coprocessor-instruction-set-architecture)
  - [2.1 Instruction Category Overview](#21-instruction-category-overview)
  - [2.2 Coprocessor Data Processing (CDP) Instructions](#22-coprocessor-data-processing-cdp-instructions)
  - [2.3 Coprocessor Register Transfer Instructions (MRC/MCR)](#23-coprocessor-register-transfer-instructions-mrcmcr)
  - [2.4 Coprocessor Load/Store Instructions (LDC/STC)](#24-coprocessor-loadstore-instructions-ldcstc)
- [3. Floating-Point Unit Architecture and Programming](#3-floating-point-unit-architecture-and-programming)
  - [3.1 VFP Register Organization](#31-vfp-register-organization)
  - [3.2 VFP Instruction Set](#32-vfp-instruction-set)
  - [3.3 VFP Performance Characteristics](#33-vfp-performance-characteristics)
- [4. Implementation in ARM Cortex-M Processors](#4-implementation-in-arm-cortex-m-processors)
  - [4.1 FPU Integration in Cortex-M4/M7](#41-fpu-integration-in-cortex-m4m7)
  - [4.2 Enabling the FPU in Cortex-M4](#42-enabling-the-fpu-in-cortex-m4)
  - [4.3 Lazy Stacking in Cortex-M4F](#43-lazy-stacking-in-cortex-m4f)
- [5. Practical Programming Examples](#5-practical-programming-examples)
  - [5.1 Example 1: Floating-Point Array Processing](#51-example-1-floating-point-array-processing)
  - [5.2 Example 2: Temperature Conversion with Coprocessor Control](#52-example-2-temperature-conversion-with-coprocessor-control)
  - [5.3 Example 3: Complex Number Multiplication](#53-example-3-complex-number-multiplication)
- [6. Summary](#6-summary)
