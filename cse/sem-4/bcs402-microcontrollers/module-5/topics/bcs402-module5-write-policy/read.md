...
- [Write Policy: Write-Back or Write-Through](#write-policy-write-back-or-write-through)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [Write-Through Policy](#write-through-policy)
  - [Write-Back Policy](#write-back-policy)
  - [Write Miss Handling](#write-miss-handling)
  - [Dirty Bit and Write-Back Buffer](#dirty-bit-and-write-back-buffer)
- [Examples](#examples)
  - [Example 1: Write-Through Operation](#example-1-write-through-operation)
  - [Example 2: Write-Back Operation](#example-2-write-back-operation)
  - [Example 3: Comparing Performance Impact](#example-3-comparing-performance-impact)
- [Exam Tips](#exam-tips)
