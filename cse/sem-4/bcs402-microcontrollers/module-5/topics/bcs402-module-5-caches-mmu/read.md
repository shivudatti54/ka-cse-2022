...
- [Caches and Memory Management Units](#caches-and-memory-management-units)
- [Introduction](#introduction)
- [Cache Memory Fundamentals](#cache-memory-fundamentals)
  - [The Memory Wall Problem and Cache Need](#the-memory-wall-problem-and-cache-need)
  - [Cache Organization and Structure](#cache-organization-and-structure)
  - [Cache Mapping Techniques](#cache-mapping-techniques)
- [Cache Operations and Policies](#cache-operations-and-policies)
  - [Write Policies](#write-policies)
  - [Replacement Policies](#replacement-policies)
  - [Cache Coherence in Multi-Core Systems](#cache-coherence-in-multi-core-systems)
- [Cache Performance Analysis](#cache-performance-analysis)
  ...
  - [Cache Conflict Analysis](#cache-conflict-analysis)
- [Coprocessor 15 (CP15) - System Control Coprocessor](#coprocessor-15-cp15---system-control-coprocessor)
  - [Overview and Purpose](#overview-and-purpose)
  - [Key CP15 Registers for Cache/MMU Control](#key-cp15-registers-for-cachemmu-control)
  - [Cache Configuration Sequence](#cache-configuration-sequence)
- [Memory Management Unit (MMU)](#memory-management-unit-mmu)
  - [MMU Architecture and Functions](#mmu-architecture-and-functions)
  - [Virtual Address Translation](#virtual-address-translation)
  - [Page Table Structure](#page-table-structure)
  - [Memory Regions and Attributes](#memory-regions-and-attributes)
  - [Access Permissions](#access-permissions)
  - [TLB Management Operations](#tlb-management-operations)
- [Integration in Microcontroller Systems](#integration-in-microcontroller-systems)
  - [ARM Cortex-M7 Cache Configuration](#arm-cortex-m7-cache-configuration)
  - [Cache and MMU Interaction](#cache-and-mmu-interaction)
...
- aliasing: same physical address mapped to different virtual addresses -solution: cache coloring, ASID tagging
