...
- [Measuring Cache Efficiency](#measuring-cache-efficiency)
- [Introduction](#introduction)
- [Theoretical Foundations](#theoretical-foundations)
  - [Cache Memory Organization](#cache-memory-organization)
  - [Cache Hit and Miss Dynamics](#cache-hit-and-miss-dynamics)
  - [Cache Hit Ratio and Miss Rate](#cache-hit-ratio-and-miss-rate)
- [Average Memory Access Time (AMAT)](#average-memory-access-time-amat)
  - [Derivation of AMAT Formula](#derivation-of-amat-formula)
  - [AMAT for Multi-Level Caches](#amat-for-multi-level-caches)
  - [Cache Efficiency](#cache-efficiency)
- [Classification of Cache Misses](#classification-of-cache-misses)
  - [1. Compulsory Misses (Cold Misses)](#1-compulsory-misses-cold-misses)
  - [2. Capacity Misses](#2-capacity-misses)
  - [3. Conflict Misses](#3-conflict-misses)
- [Measurement Methodologies](#measurement-methodologies)
  - [Hardware Performance Counters (CP15 Registers)](#hardware-performance-counters-cp15-registers)
  - [Software Instrumentation](#software-instrumentation)
  - [Simulation-Based Analysis](#simulation-based-analysis)
  - [Analytical Modeling](#analytical-modeling)
- [Practical Examples and Problems](#practical-examples-and-problems)
  - [Example 3: AMAT Calculation for Embedded Application](#example-3-amat-calculation-for-embedded-application)
  - [Example 4: Cache Efficiency Comparison](#example-4-cache-efficiency-comparison)
- [Summary](#summary)
