...
- [Cache Miss Allocation Policy](#cache-miss-allocation-policy)
- [Introduction](#introduction)
- [Theoretical Foundation](#theoretical-foundation)
  - [Cache Miss Taxonomy](#cache-miss-taxonomy)
  - [Average Memory Access Time Analysis](#average-memory-access-time-analysis)
- [Cache Miss Allocation Policies](#cache-miss-allocation-policies)
  - [Policy 1: Fetch-on-Miss (Allocate on Miss)](#policy-1-fetch-on-miss-allocate-on-miss)
  - [Policy 2: Write-Allocate (Fetch-on-Miss for Writes)](#policy-2-write-allocate-fetch-on-miss-for-writes)
  - [Policy 3: No-Allocate (Write-Around)](#policy-3-no-allocate-write-around)
- [Placement and Replacement Policies](#placement-and-replacement-policies)
  - [Cache Placement Strategies](#cache-placement-strategies)
  - [Victim Selection (Replacement Algorithms)](#victim-selection-replacement-algorithms)
- [Numerical Examples](#numerical-examples)
  - [Example 1: Hit Ratio Calculation with Fetch-on-Miss](#example-1-hit-ratio-calculation-with-fetch-on-miss)
  - [Example 2: AMAT Comparison for Allocation Policies](#example-2-amat-comparison-for-allocation-policies)
- [ARM Coprocessor 15 Integration](#arm-coprocessor-15-integration)
- [Summary](#summary)
