...
- [Warshall's and Floyd's Algorithms: A Dynamic Programming Approach](#warshalls-and-floyds-algorithms-a-dynamic-programming-approach)
- [Introduction](#introduction)
- [Theoretical Foundation: Optimal Substructure](#theoretical-foundation-optimal-substructure)
...
- [Floyd's Algorithm](#floyds-algorithm)
  ...
  - [Proof of Correctness](#proof-of-correctness)
  - [Handling Negative Weights and Negative Cycles](#handling-negative-weights-and-negative-cycles)
  - [Complexity Analysis](#complexity-analysis)
- [Comparative Analysis](#comparative-analysis)
- [Step-by-Step Numerical Examples](#step-by-step-numerical-examples)
  - [Example 1: Warshall's Algorithm](#example-1-warshalls-algorithm)
  - [Example 2: Floyd's Algorithm](#example-2-floyds-algorithm)
- [Applications](#applications)
  - [Warshall's Algorithm Applications](#warshalls-algorithm-applications)
  - [Floyd's Algorithm Applications](#floyds-algorithm-applications)
