...
- [Column-Based or Wide-Column NoSQL Systems](#column-based-or-wide-column-nosql-systems)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [Architecture of Wide-Column Stores](#architecture-of-wide-column-stores)
  - [Partitioning and Distribution](#partitioning-and-distribution)
  - [Consistency Models](#consistency-models)
  - [Data Modeling in Wide-Column Stores](#data-modeling-in-wide-column-stores)
  - [Storage Engine Architecture](#storage-engine-architecture)
- [Examples](#examples)
  - [Example 1: Apache Cassandra Data Model](#example-1-apache-cassandra-data-model)
  - [Example 2: Time-Series Data in Apache HBase](#example-2-time-series-data-in-apache-hbase)
  - [Example 3: Amazon DynamoDB Design](#example-3-amazon-dynamodb-design)
- [Exam Tips](#exam-tips)
