...
- [Concurrency Control Based on Timestamp Ordering](#concurrency-control-based-on-timestamp-ordering)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [Timestamps](#timestamps)
  - [Timestamp Ordering Protocol](#timestamp-ordering-protocol)
  - [Thomas' Write Rule](#thomas-write-rule)
  - [Strict Timestamp Ordering](#strict-timestamp-ordering)
- [Examples](#examples)
  - [Example 1: Basic Timestamp Ordering with Read and Write Operations](#example-1-basic-timestamp-ordering-with-read-and-write-operations)
  - [Example 2: Demonstrating Thomas' Write Rule](#example-2-demonstrating-thomas-write-rule)
  - [Example 3: Schedule Validation in Timestamp Ordering](#example-3-schedule-validation-in-timestamp-ordering)
- [Exam Tips](#exam-tips)
