...
- [Document-Based NoSQL Systems and MongoDB](#document-based-nosql-systems-and-mongodb)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [Overview of NoSQL Databases](#overview-of-nosql-databases)
  - [MongoDB Architecture](#mongodb-architecture)
  - [Data Model: Documents, Collections, and Databases](#data-model-documents-collections-and-databases)
  ...
  - [Sharding and Horizontal Scalability](#sharding-and-horizontal-scalability)
- [Examples](#examples)
  - [Example 1: Creating and Querying Collections](#example-1-creating-and-querying-collections)
  - [Example 2: Using Aggregation Pipeline](#example-2-using-aggregation-pipeline)
  - [Example 3: Creating Indexes for Performance](#example-3-creating-indexes-for-performance)
- [Exam Tips](#exam-tips)
