...
- [Multiversion Concurrency Control Techniques](#multiversion-concurrency-control-techniques)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [Fundamentals of Multiversioning](#fundamentals-of-multiversioning)
  - [Timestamp-Based Concurrency Control](#timestamp-based-concurrency-control)
  - [Snapshot Isolation](#snapshot-isolation)
  - [Multi-Version Timestamp Ordering (MVTO)](#multi-version-timestamp-ordering-mvto)
  - [Serializable Snapshot Isolation (SSI)](#serializable-snapshot-isolation-ssi)
- [Examples](#examples)
  - [Example 1: Timestamp-Based Concurrency Control](#example-1-timestamp-based-concurrency-control)
  - [Example 2: Snapshot Isolation - Write-Write Conflict](#example-2-snapshot-isolation---write-write-conflict)
  - [Example 3: Read Operations Never Block](#example-3-read-operations-never-block)
- [Exam Tips](#exam-tips)
