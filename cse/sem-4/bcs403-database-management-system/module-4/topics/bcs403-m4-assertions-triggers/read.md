...
- [Specifying Constraints as Assertions and Action Triggers](#specifying-constraints-as-assertions-and-action-triggers)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [1. Database Constraints: A Review](#1-database-constraints-a-review)
  - [2. Assertions](#2-assertions)
  - [3. Triggers (Action Triggers)](#3-triggers-action-triggers)
  - [4. Trigger Examples](#4-trigger-examples)
  - [5. INSTEAD OF Triggers](#5-instead-of-triggers)
  - [6. Differences Between Assertions and Triggers](#6-differences-between-assertions-and-triggers)
- [Examples](#examples)
  - [Worked Example 1: Inventory Management System](#worked-example-1-inventory-management-system)
  - [Worked Example 2: University Course Enrollment](#worked-example-2-university-course-enrollment)
- [Exam Tips](#exam-tips)
