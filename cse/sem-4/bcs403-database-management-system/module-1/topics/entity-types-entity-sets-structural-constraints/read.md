...
- [Entity Types, Entity Sets, and Structural Constraints](#entity-types-entity-sets-and-structural-constraints)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [Entity Types and Entity Sets](#entity-types-and-entity-sets)
  - [Attributes](#attributes)
  - [Keys and Structural Constraints](#keys-and-structural-constraints)
  - [Structural Constraints](#structural-constraints)
- [Examples](#examples)
  - [Example 1: University Database](#example-1-university-database)
  - [Example 2: Banking System](#example-2-banking-system)
  - [Example 3: Structural Constraint Identification](#example-3-structural-constraint-identification)
- [Exam Tips](#exam-tips)
