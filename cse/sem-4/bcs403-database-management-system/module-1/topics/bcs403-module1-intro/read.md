...
- [Key Concepts](#key-concepts)
  ...
  - [Need for DBMS](#need-for-dbms)
  - [Characteristics of DBMS](#characteristics-of-dbms)
  - [Database Users](#database-users)
  - [ANSI/SPARC Architecture](#ansisparc-architecture)
  - [Types of Database Systems](#types-of-database-systems)
  - [Data Models](#data-models)
- [Examples](#examples)
  - [Example 1: File Processing vs DBMS Problem](#example-1-file-processing-vs-dbms-problem)
  - [Example 2: Query Processing in DBMS](#example-2-query-processing-in-dbms)
  - [Example 3: Concurrent Access Scenario](#example-3-concurrent-access-scenario)
- [Exam Tips](#exam-tips)
