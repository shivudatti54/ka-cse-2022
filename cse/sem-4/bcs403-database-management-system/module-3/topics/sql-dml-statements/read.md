...
- [Insert, Delete, and Update Statements in SQL](#insert-delete-and-update-statements-in-sql)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [1. INSERT Statement](#1-insert-statement)
  - [2. DELETE Statement](#2-delete-statement)
  - [3. UPDATE Statement](#3-update-statement)
  - [4. Transaction Control](#4-transaction-control)
- [Examples](#examples)
  - [Example 1: Insert Statement with Multiple Variations](#example-1-insert-statement-with-multiple-variations)
  - [Example 2: Update Statement with Calculations](#example-2-update-statement-with-calculations)
  - [Example 3: Delete Statement with Conditions](#example-3-delete-statement-with-conditions)
  - [Example 4: Transaction Control Example](#example-4-transaction-control-example)
- [Exam Tips](#exam-tips)
