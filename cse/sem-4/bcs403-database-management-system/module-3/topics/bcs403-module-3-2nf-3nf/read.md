...
- [Second and Third Normal Forms in Database Design](#second-and-third-normal-forms-in-database-design)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [Second Normal Form (2NF)](#second-normal-form-2nf)
  - [Third Normal Form (3NF)](#third-normal-form-3nf)
- [Examples](#examples)
  - [Example 1: Converting to 2NF](#example-1-converting-to-2nf)
  - [Example 2: Converting to 3NF](#example-2-converting-to-3nf)
  - [Example 3: Comprehensive Normalization](#example-3-comprehensive-normalization)
- [Exam Tips](#exam-tips)
