...
- [Additional Features of SQL](#additional-features-of-sql)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [1. Views in SQL](#1-views-in-sql)
  - [2. Sequences](#2-sequences)
  - [3. Indexes](#3-indexes)
  - [4. Integrity Constraints](#4-integrity-constraints)
  - [5. Set Operations](#5-set-operations)
  - [6. Aggregate Functions with GROUP BY and HAVING](#6-aggregate-functions-with-group-by-and-having)
  - [7. Subqueries](#7-subqueries)
  - [8. Transaction Control Language (TCL)](#8-transaction-control-language-tcl)
- [Examples](#examples)
  - [Example 1: Creating and Using a View](#example-1-creating-and-using-a-view)
  - [Example 2: Using Sequence and Table Insert](#example-2-using-sequence-and-table-insert)
  - [Example 3: Complex Query with Multiple Features](#example-3-complex-query-with-multiple-features)
- [Exam Tips](#exam-tips)
