...
- [Key Concepts](#key-concepts)
  ...
  - [2. Linear Dependence](#2-linear-dependence)
  - [3. Linear Independence](#3-linear-independence)
  - [4. Theorems and Properties](#4-theorems-and-properties)
  - [5. Spanning and Relationship](#5-spanning-and-relationship)
  - [6. Testing Linear Independence](#6-testing-linear-independence)
- [Examples](#examples)
  - [Example 1: Basic Linear Independence Test in ℝ³](#example-1-basic-linear-independence-test-in-)
  - [Example 2: Finding Dependence Relationship](#example-2-finding-dependence-relationship)
  - [Example 3: Using Matrix Rank](#example-3-using-matrix-rank)
- [Exam Tips](#exam-tips)
