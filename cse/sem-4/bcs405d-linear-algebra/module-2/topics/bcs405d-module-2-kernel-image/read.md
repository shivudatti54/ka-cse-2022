...
- [Kernel and Image of a Linear Transformation](#kernel-and-image-of-a-linear-transformation)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [1. Linear Transformation](#1-linear-transformation)
  - [2. Kernel (Null Space)](#2-kernel-null-space)
  - [3. Image (Range)](#3-image-range)
  - [4. Rank-Nullity Theorem](#4-rank-nullity-theorem)
  - [5. One-to-One and Onto Transformations](#5-one-to-one-and-onto-transformations)
  - [6. Finding Kernel and Image from Matrix](#6-finding-kernel-and-image-from-matrix)
- [Examples](#examples)
  - [Example 1: Finding Kernel and Image](#example-1-finding-kernel-and-image)
  - [Example 2: Determining if Transformation is One-to-One or Onto](#example-2-determining-if-transformation-is-one-to-one-or-onto)
  - [Example 3: Using Rank-Nullity Theorem](#example-3-using-rank-nullity-theorem)
- [Exam Tips](#exam-tips)
