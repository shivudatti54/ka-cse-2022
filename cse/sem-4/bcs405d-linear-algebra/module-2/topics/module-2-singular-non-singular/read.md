...
- [Singular and Non-Singular Linear Transformations](#singular-and-non-singular-linear-transformations)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [1. Definition of Linear Transformation](#1-definition-of-linear-transformation)
  - [2. Singular Linear Transformation](#2-singular-linear-transformation)
  - [3. Non-Singular Linear Transformation](#3-non-singular-linear-transformation)
  - [4. Rank and Nullity Theorem (Fundamental Theorem of Linear Transformations)](#4-rank-and-nullity-theorem-fundamental-theorem-of-linear-transformations)
  - [5. One-to-One and Onto Properties](#5-one-to-one-and-onto-properties)
  - [6. Matrix Representation and Determinant](#6-matrix-representation-and-determinant)
  - [7. Inverse Linear Transformation](#7-inverse-linear-transformation)
- [Examples](#examples)
  - [Example 1: Identifying a Singular Transformation](#example-1-identifying-a-singular-transformation)
  - [Example 2: Identifying a Singular Transformation](#example-2-identifying-a-singular-transformation)
  - [Example 3: Verifying Non-Singularity Using Rank](#example-3-verifying-non-singularity-using-rank)
- [Exam Tips](#exam-tips)
