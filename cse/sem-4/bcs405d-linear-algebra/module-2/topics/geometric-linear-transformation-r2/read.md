...
- [Geometric Linear Transformations of R²](#geometric-linear-transformations-of-r)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [Definition of Linear Transformation](#definition-of-linear-transformation)
  - [Standard Matrix Representation](#standard-matrix-representation)
...
- [Examples](#examples)
  - [Example 1: Finding the Matrix of a Transformation](#example-1-finding-the-matrix-of-a-transformation)
  - [Example 2: Applying Transformation to a Vector](#example-2-applying-transformation-to-a-vector)
  - [Example 3: Verifying Linearity and Finding Inverse](#example-3-verifying-linearity-and-finding-inverse)
- [Exam Tips](#exam-tips)
