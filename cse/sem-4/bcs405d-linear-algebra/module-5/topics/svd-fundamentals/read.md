...
- [Key Concepts](#key-concepts)
  - [Definition of SVD](#definition-of-svd)
  - [Relationship Between SVD and Eigenvalues](#relationship-between-svd-and-eigenvalues)
  - [Properties of SVD](#properties-of-svd)
  - [Geometric Interpretation](#geometric-interpretation)
  - [Low-Rank Approximation (Eckart-Young Theorem)](#low-rank-approximation-eckart-young-theorem)
- [Examples](#examples)
  - [Example 1: Compute SVD of a 2×2 Matrix](#example-1-compute-svd-of-a-22-matrix)
  - [Example 2: Rank and SVD](#example-2-rank-and-svd)
  - [Example 3: Image Compression Application](#example-3-image-compression-application)
- [Exam Tips](#exam-tips)
