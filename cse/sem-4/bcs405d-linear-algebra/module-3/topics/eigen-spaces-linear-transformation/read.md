...
- [Eigen-Spaces of a Linear Transformation](#eigen-spaces-of-a-linear-transformation)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [1. Eigenvalues and Eigenvectors](#1-eigenvalues-and-eigenvectors)
  - [2. Characteristic Polynomial and Characteristic Equation](#2-characteristic-polynomial-and-characteristic-equation)
  - [3. Eigenspaces](#3-eigenspaces)
  - [4. Algebraic and Geometric Multiplicity](#4-algebraic-and-geometric-multiplicity)
  - [5. Diagonalization](#5-diagonalization)
  - [6. Cayley-Hamilton Theorem](#6-cayley-hamilton-theorem)
- [Examples](#examples)
  - [Example 1: Finding Eigenvalues and Eigenspaces](#example-1-finding-eigenvalues-and-eigenspaces)
  - [Example 2: Checking Diagonalizability](#example-2-checking-diagonalizability)
