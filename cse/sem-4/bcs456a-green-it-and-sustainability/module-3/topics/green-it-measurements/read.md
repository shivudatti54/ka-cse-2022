...
- [Measurements and Sustainability](#measurements-and-sustainability)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [Carbon Footprint Measurement](#carbon-footprint-measurement)
  - [Power Usage Effectiveness (PUE)](#power-usage-effectiveness-pue)
  - [Performance per Watt](#performance-per-watt)
  - [Energy Reuse Factor (ERF)](#energy-reuse-factor-erf)
  - [Life Cycle Assessment (LCA)](#life-cycle-assessment-lca)
  - [Green IT Maturity Models](#green-it-maturity-models)
  - [Electronic Waste (E-Waste) Metrics](#electronic-waste-e-waste-metrics)
- [Examples](#examples)
  - [Example 1: Calculating Data Center PUE](#example-1-calculating-data-center-pue)
  - [Example 2: Carbon Footprint Calculation](#example-2-carbon-footprint-calculation)
  - [Example 3: Evaluating Green IT Maturity](#example-3-evaluating-green-it-maturity)
- [Exam Tips](#exam-tips)
