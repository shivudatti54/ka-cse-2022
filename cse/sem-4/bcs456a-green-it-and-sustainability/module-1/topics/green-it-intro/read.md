...
- [Key Concepts](#key-concepts)
  - [1. Definition and Scope of Green IT](#1-definition-and-scope-of-green-it)
  - [2. The Three Pillars of Sustainability](#2-the-three-pillars-of-sustainability)
  - [3. Environmental Impact of IT](#3-environmental-impact-of-it)
  - [4. Green IT Strategies and Frameworks](#4-green-it-strategies-and-frameworks)
  - [5. Virtualization and Cloud Computing](#5-virtualization-and-cloud-computing)
  - [6. Sustainable Software Development](#6-sustainable-software-development)
- [Examples](#examples)
  - [Example 1: Data Center Energy Efficiency Calculation](#example-1-data-center-energy-efficiency-calculation)
  - [Example 2: Virtualization Server Consolidation](#example-2-virtualization-server-consolidation)
  - [Example 3: Green Software Design](#example-3-green-software-design)
- [Exam Tips](#exam-tips)
