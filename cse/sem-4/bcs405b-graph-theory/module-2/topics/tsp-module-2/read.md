...
- [Key Concepts](#key-concepts)
  - [Definition and Mathematical Formulation](#definition-and-mathematical-formulation)
  - [Complete Graph and Metric TSP](#complete-graph-and-metric-tsp)
...
- [Examples](#examples)
  - [Example 1: Solving TSP using Dynamic Programming](#example-1-solving-tsp-using-dynamic-programming)
  - [Example 2: Nearest Neighbor Heuristic](#example-2-nearest-neighbor-heuristic)
  - [Example 3: Branch and Bound Concept](#example-3-branch-and-bound-concept)
- [Exam Tips](#exam-tips)
