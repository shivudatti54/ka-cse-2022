...
- **Signature Flow:** Understand the step-by-step process of creating and verifying a digital signature. Remember that the message itself is _hashed_ first, and then the _hash_ is signed, not the entire message.
