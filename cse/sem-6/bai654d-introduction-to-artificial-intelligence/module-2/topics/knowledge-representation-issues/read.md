...
This is one of the oldest and most critical debates in KR. It defines _what_ knowledge is represented versus _how_ it is used.
...
- **Issues:** Lack of standardized formal semantics (what does an "is-a" link _really_ mean?), can become computationally complex with many nodes and links.
...
_ASCII Diagram: A simple semantic network showing inheritance._
