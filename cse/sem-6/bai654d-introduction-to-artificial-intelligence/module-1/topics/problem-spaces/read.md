...
```python
(0,0) → Fill 4L: (4,0) → Fill 3L: (0,3)
(4,0) → Pour to 3L: (1,3) → Empty 4L: (0,0) → Empty 3L: (4,0) [same state]
(1,3) → Empty 3L: (1,0) → Pour to 3L: (0,1) [after emptying 3L first]
```
...
- Problem spaces are crucial in AI problem-solving
- Four essential components: initial state, goal state, actions, path cost
- Problem spaces can be represented as graphs or trees
- Different problems require different representations and search strategies
- Practice with classic problems to understand problem formulation
- Pay attention to constraints and problem space characteristics when solving problems.
