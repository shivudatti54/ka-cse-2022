...
This is the most common algorithm for circle generation. It is efficient, uses only integer arithmetic, and is a classic example of a _decision parameter_ based algorithm.
