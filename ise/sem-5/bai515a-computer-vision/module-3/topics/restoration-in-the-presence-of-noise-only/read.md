...
- [**Restoration in the Presence of Noise Only**](#restoration-in-the-presence-of-noise-only)
- [**Introduction**](#introduction)
- [**Types of Noise**](#types-of-noise)
- [**Mathematical Model**](#mathematical-model)
- [**Restoration Methods**](#restoration-methods)
  - [1. **Wiener Filter**](#1-wiener-filter)
  - [2. **Maximum a Posteriori (MAP) Estimation**](#2-maximum-a-posteriori-map-estimation)
- [**Advantages and Disadvantages**](#advantages-and-disadvantages)
  - [Advantages:](#advantages)
  - [Disadvantages:](#disadvantages)
- [**Conclusion**](#conclusion)
- [Define the forward model](#define-the-forward-model)
- [Define the noise model](#define-the-noise-model)
- [Define the Wiener filter kernel](#define-the-wiener-filter-kernel)
- [Define the MAP estimation method](#define-the-map-estimation-method)
- [Estimate the forward model](#estimate-the-forward-model)
- [Estimate the noise variance](#estimate-the-noise-variance)
- [Estimate the original image](#estimate-the-original-image)
- [Simulate an image degradation model](#simulate-an-image-degradation-model)
- [Apply the Wiener filter](#apply-the-wiener-filter)
- [Apply the MAP estimation method](#apply-the-map-estimation-method)
