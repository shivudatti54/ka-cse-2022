...
- [Point Operations in Computer Vision](#point-operations-in-computer-vision)
- [1. Introduction to Point Operations](#1-introduction-to-point-operations)
- [2. Why Point Operations?](#2-why-point-operations)
- [3. Brightness Adjustment](#3-brightness-adjustment)
  - [3.1 Linear Brightness Adjustment](#31-linear-brightness-adjustment)
  - [3.2 Applications](#32-applications)
- [4. Contrast Adjustment](#4-contrast-adjustment)
  - [4.1 Linear Contrast Stretching](#41-linear-contrast-stretching)
  - [4.2 Combined Brightness and Contrast](#42-combined-brightness-and-contrast)
  - [4.3 Contrast Stretching to Full Range](#43-contrast-stretching-to-full-range)
- [5. Image Negative (Inversion)](#5-image-negative-inversion)
- [6. Thresholding](#6-thresholding)
  - [6.1 Basic Thresholding](#61-basic-thresholding)
  - [6.2 Types of Thresholding](#62-types-of-thresholding)
  - [6.3 Threshold Selection Methods](#63-threshold-selection-methods)
  - [6.4 Applications](#64-applications)
- [7. Histogram Equalization](#7-histogram-equalization)
  - [7.1 Image Histogram](#71-image-histogram)
  - [7.2 Why Histogram Equalization?](#72-why-histogram-equalization)
  - [7.3 Histogram Equalization Algorithm](#73-histogram-equalization-algorithm)
  - [7.4 Example](#74-example)
  - [7.5 Properties](#75-properties)
- [8. Gamma Correction](#8-gamma-correction)
  - [8.1 Gamma Transformation](#81-gamma-transformation)
  - [8.2 Gamma Values](#82-gamma-values)
  - [8.3 Applications](#83-applications)
- [9. Logarithmic Transformation](#9-logarithmic-transformation)
- [10. Practical Implementation Tips](#10-practical-implementation-tips)
  - [10.1 Clipping Values](#101-clipping-values)
  - [10.2 Lookup Tables (LUT)](#102-lookup-tables-lut)
