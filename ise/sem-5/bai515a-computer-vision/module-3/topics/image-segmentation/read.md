...
- [Basic Segmentation Concepts](#basic-segmentation-concepts)
  - [Pixel Similarity and Discontinuity](#pixel-similarity-and-discontinuity)
- [Edge Detection](#edge-detection)
  - [Types of Edges](#types-of-edges)
  - [Edge Detection Operators](#edge-detection-operators)
...
- [Region-Based Segmentation](#region-based-segmentation)
  ...
  - [Region Splitting and Merging](#region-splitting-and-merging)
- [Advanced Segmentation Techniques](#advanced-segmentation-techniques)
  - [Watershed Algorithm](#watershed-algorithm)
  - [Clustering-Based Segmentation](#clustering-based-segmentation)
- [Evaluation of Segmentation Results](#evaluation-of-segmentation-results)
  - [Quantitative Metrics](#quantitative-metrics)
  - [Challenges in Image Segmentation](#challenges-in-image-segmentation)
