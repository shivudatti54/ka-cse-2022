...
- [Image Degradation and Restoration Model](#image-degradation-and-restoration-model)
- [1. Introduction to Image Degradation](#1-introduction-to-image-degradation)
- [2. The Image Degradation Model](#2-the-image-degradation-model)
  - [2.1 The Mathematical Formulation](#21-the-mathematical-formulation)
  - [2.2 Visualizing the Model with a Block Diagram](#22-visualizing-the-model-with-a-block-diagram)
- [3. Components of Degradation](#3-components-of-degradation)
  - [3.1 The Point Spread Function (PSF) - `h(x, y)`](#31-the-point-spread-function-psf---hx-y)
  - [3.2 Additive Noise - `η(x, y)`](#32-additive-noise---x-y)
- [4. The Image Restoration Process](#4-the-image-restoration-process)
  - [4.1 Inverse Filtering](#41-inverse-filtering)
  - [4.2 Wiener Filtering (Minimum Mean Square Error Filter)](#42-wiener-filtering-minimum-mean-square-error-filter)
  - [4.3 Steps for Restoration](#43-steps-for-restoration)
...
| **Salt-and-Pepper** | `p(z) = { Pₛ for z = 0 (pepper), Pₚ for z = max (salt) }` | Faulty pixels, analog-to-digital converter errors, transmission errors | _[Diagram: Salt and Pepper noise: black and white dots scattered on an image]_ |
...
See: `assets/a-model-of-image-degradationrestoration-process.svg` for an interactive visual explanation of this topic.
