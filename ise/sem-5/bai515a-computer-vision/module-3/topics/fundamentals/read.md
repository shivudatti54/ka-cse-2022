...
- [Computer Vision Fundamentals: Digital Images](#computer-vision-fundamentals-digital-images)
- [1. What is a Digital Image?](#1-what-is-a-digital-image)
  - [1.1 Continuous vs Discrete Images](#11-continuous-vs-discrete-images)
- [2. Pixels: The Building Blocks](#2-pixels-the-building-blocks)
  - [2.1 What is a Pixel?](#21-what-is-a-pixel)
  - [2.2 Image Resolution](#22-image-resolution)
- [3. Image Types](#3-image-types)
  - [3.1 Binary Images](#31-binary-images)
  - [3.2 Grayscale Images](#32-grayscale-images)
  - [3.3 Color Images](#33-color-images)
  - [3.4 Multi-channel Images](#34-multi-channel-images)
- [4. Color Spaces](#4-color-spaces)
  - [4.1 RGB (Red, Green, Blue)](#41-rgb-red-green-blue)
  - [4.2 HSV (Hue, Saturation, Value)](#42-hsv-hue-saturation-value)
  - [4.3 HSL (Hue, Saturation, Lightness)](#43-hsl-hue-saturation-lightness)
  - [4.4 YCbCr (Luminance, Chrominance)](#44-ycbcr-luminance-chrominance)
  - [4.5 LAB (Lightness, A, B)](#45-lab-lightness-a-b)
  - [4.6 Choosing the Right Color Space](#46-choosing-the-right-color-space)
- [5. Image Representation in Memory](#5-image-representation-in-memory)
  - [5.1 Matrix Representation](#51-matrix-representation)
  - [5.2 Coordinate Systems](#52-coordinate-systems)
  - [5.3 File Size Calculation](#53-file-size-calculation)
- [6. Image File Formats](#6-image-file-formats)
  - [6.1 Lossless Formats](#61-lossless-formats)
  - [6.2 Lossy Formats](#62-lossy-formats)
  - [6.3 Format Comparison](#63-format-comparison)
- [7. Pixel Neighborhoods](#7-pixel-neighborhoods)
  - [7.1 4-Connected Neighborhood (N4)](#71-4-connected-neighborhood-n4)
  - [7.2 8-Connected Neighborhood (N8)](#72-8-connected-neighborhood-n8)
