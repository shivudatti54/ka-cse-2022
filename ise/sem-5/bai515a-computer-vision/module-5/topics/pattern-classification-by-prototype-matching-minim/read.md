...
- [Pattern Classification by Prototype Matching (Minimum Distance Classifier)](#pattern-classification-by-prototype-matching-minimum-distance-classifier)
  - [Introduction](#introduction)
  - [Prototype Matching](#prototype-matching)
  - [Minimum Distance Classifier](#minimum-distance-classifier)
  - [How Minimum Distance Classifier Works](#how-minimum-distance-classifier-works)
  - [Advantages](#advantages)
  - [Disadvantages](#disadvantages)
  - [Example](#example)
  - [Code](#code)
- [Load the dataset](#load-the-dataset)
- [Create a minimum distance classifier](#create-a-minimum-distance-classifier)
- [Preprocess the input image](#preprocess-the-input-image)
- [Calculate the distance between the input image and the prototypes](#calculate-the-distance-between-the-input-image-and-the-prototypes)
- [Assign a class label based on the minimum distance](#assign-a-class-label-based-on-the-minimum-distance)
