...
- [Pattern Classification and the Minimum Distance Classifier](#pattern-classification-and-the-minimum-distance-classifier)
- [Introduction to Pattern Classification](#introduction-to-pattern-classification)
- [The Pattern Classification Pipeline](#the-pattern-classification-pipeline)
- [Introduction to Classifiers](#introduction-to-classifiers)
- [The Minimum Distance Classifier (MDC)](#the-minimum-distance-classifier-mdc)
  - [How it Works](#how-it-works)
  - [Distance Metrics](#distance-metrics)
  - [Geometric Interpretation](#geometric-interpretation)
  - [Advantages and Disadvantages](#advantages-and-disadvantages)
- [Step-by-Step Numerical Example](#step-by-step-numerical-example)
- [Relationship to Morphology and Feature Extraction](#relationship-to-morphology-and-feature-extraction)
- [Exam Tips](#exam-tips)
