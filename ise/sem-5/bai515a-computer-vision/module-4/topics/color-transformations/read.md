...
- [Color Transformations in Image Processing](#color-transformations-in-image-processing)
- [Introduction to Color Transformations](#introduction-to-color-transformations)
- [Color Fundamentals Recap](#color-fundamentals-recap)
- [Color Models and Their Role in Transformations](#color-models-and-their-role-in-transformations)
  - [RGB (Red, Green, Blue)](#rgb-red-green-blue)
  - [CMY/K (Cyan, Magenta, Yellow, Key/Black)](#cmyk-cyan-magenta-yellow-keyblack)
  - [HSI (Hue, Saturation, Intensity)](#hsi-hue-saturation-intensity)
- [Types of Color Transformations](#types-of-color-transformations)
  - [1. Linear Transformations](#1-linear-transformations)
  - [2. Nonlinear Transformations](#2-nonlinear-transformations)
  - [3. Component-wise Transformations](#3-component-wise-transformations)
  - [4. Inter-channel Transformations](#4-inter-channel-transformations)
- [Applications of Color Transformations](#applications-of-color-transformations)
  - [Color Correction and Enhancement](#color-correction-and-enhancement)
...
- [Implementation Considerations](#implementation-considerations)
  ...
  - [Color Gamut Considerations](#color-gamut-considerations)
- [Examples of Common Transformations](#examples-of-common-transformations)
  - [1. Color Balancing](#1-color-balancing)
  - [2. Sepia Tone Effect](#2-sepia-tone-effect)
  - [3. Chromatic Adaptation](#3-chromatic-adaptation)
- [Advanced Transformation Techniques](#advanced-transformation-techniques)
  - [Color Transfer Between Images](#color-transfer-between-images)
  - [Color Constancy Algorithms](#color-constancy-algorithms)
- [Exam Tips](#exam-tips)
