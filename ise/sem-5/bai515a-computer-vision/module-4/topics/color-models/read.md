...
- [Color Models in Digital Image Processing](#color-models-in-digital-image-processing)
- [Introduction to Color Models](#introduction-to-color-models)
- [Color Fundamentals](#color-fundamentals)
  - [The Nature of Color](#the-nature-of-color)
  - [The Visible Spectrum](#the-visible-spectrum)
  - [Primary Colors](#primary-colors)
- [Major Color Models](#major-color-models)
...
- [Applications in Image Processing](#applications-in-image-processing)
  ...
  - [Pseudocolor Processing](#pseudocolor-processing)
  - [Full-Color Processing](#full-color-processing)
