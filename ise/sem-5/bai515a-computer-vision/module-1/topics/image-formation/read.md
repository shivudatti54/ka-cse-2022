...
- [Introduction to Photometric Image Formation](#introduction-to-photometric-image-formation)
- [The Physics of Light and Surfaces](#the-physics-of-light-and-surfaces)
  - [Light Sources and Illumination](#light-sources-and-illumination)
  - [Surface Reflection Models](#surface-reflection-models)
- [The Image Formation Process](#the-image-formation-process)
  - [The Pinhole Camera Model](#the-pinhole-camera-model)
  - [The Digital Camera Process](#the-digital-camera-process)
- [Radiometry and Photometry](#radiometry-and-photometry)
  - [Radiometric Quantities](#radiometric-quantities)
  - [Photometric Quantities](#photometric-quantities)
- [The Image Irradiance Equation](#the-image-irradiance-equation)
- [The Digital Image Representation](#the-digital-image-representation)
  - [From Irradiance to Pixel Values](#from-irradiance-to-pixel-values)
  - [Camera Response Function](#camera-response-function)
