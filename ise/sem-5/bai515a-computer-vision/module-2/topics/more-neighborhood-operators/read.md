...
- [Neighborhood Operators in Image Processing](#neighborhood-operators-in-image-processing)
- [Introduction to Neighborhood Operators](#introduction-to-neighborhood-operators)
- [Convolution and Correlation](#convolution-and-correlation)
  - [Mathematical Foundation](#mathematical-foundation)
  - [Kernel Representation](#kernel-representation)
- [Common Neighborhood Operations](#common-neighborhood-operations)
...
- [Implementation Considerations](#implementation-considerations)
  - [Border Handling](#border-handling)
  - [Computational Efficiency](#computational-efficiency)
- [Applications of Neighborhood Operators](#applications-of-neighborhood-operators)
  - [Noise Reduction](#noise-reduction)
  - [Edge Detection](#edge-detection)
  - [Feature Enhancement](#feature-enhancement)
- [Advanced Neighborhood Operations](#advanced-neighborhood-operations)
  - [Non-Linear Filters](#non-linear-filters)
  - [Adaptive Filters](#adaptive-filters)
- [Comparison of Common Filters](#comparison-of-common-filters)
- [Practical Implementation Example](#practical-implementation-example)
- [Python example using OpenCV for Sobel edge detection](#python-example-using-opencv-for-sobel-edge-detection)
- [Read image](#read-image)
- [Apply Sobel operator](#apply-sobel-operator)
- [Calculate gradient magnitude](#calculate-gradient-magnitude)
- [Normalize and convert to uint8](#normalize-and-convert-to-uint8)
