...
Most DBMSs provide tools to view the execution plan _without_ actually running the query (often using an `EXPLAIN` or `EXPLAIN PLAN` command). The output can be textual or graphical.
