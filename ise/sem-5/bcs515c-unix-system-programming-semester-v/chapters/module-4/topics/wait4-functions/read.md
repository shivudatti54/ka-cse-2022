...
6.  **Derived Datatypes:** Understand the _purpose_ of derived datatypes (to handle non-contiguous data) and be familiar with the general process of creating, committing, using, and freeing them.
