...
- **Differentiate the Terms:** Know that **parsing** is about _extracting_ fields, while **normalization** is about _standardizing_ them. They are related but distinct steps.
