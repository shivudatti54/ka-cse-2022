...
- [Virtualization Structure and Tools](#virtualization-structure-and-tools)
- [Introduction to Virtualization Structure](#introduction-to-virtualization-structure)
- [Key Components of Virtualization Architecture](#key-components-of-virtualization-architecture)
  - [1. Host Machine](#1-host-machine)
  - [2. Hypervisor (VMM)](#2-hypervisor-vmm)
  - [3. Guest Operating System](#3-guest-operating-system)
  - [4. Virtual Machine (VM)](#4-virtual-machine-vm)
...
- [Virtualization Tools and Technologies](#virtualization-tools-and-technologies)
  - [1. VMware vSphere Suite](#1-vmware-vsphere-suite)
  - [2. Microsoft Hyper-V](#2-microsoft-hyper-v)
  - [3. KVM (Kernel-based Virtual Machine)](#3-kvm-kernel-based-virtual-machine)
  - [4. Xen](#4-xen)
  - [5. Oracle VirtualBox](#5-oracle-virtualbox)
...
- [Virtualization of Resources](#virtualization-of-resources)
  ...
  - [I/O Device Virtualization](#io-device-virtualization)
- [Virtualization Management Tools](#virtualization-management-tools)
  - [Orchestration Platforms](#orchestration-platforms)
  - [Monitoring and Performance Tools](#monitoring-and-performance-tools)
- [Comparison of Virtualization Technologies](#comparison-of-virtualization-technologies)
- [Virtualization in Data Center Automation](#virtualization-in-data-center-automation)
- [Exam Tips](#exam-tips)
...
Installed directly on the host's hardware. Offers better performance and security as it doesn't rely on a host OS. Examples: VMware ESXi, Microsoft Hyper-V, Xen, KVM
...
Runs as an application on top of a host operating system. Easier to set up but may have performance overhead. Examples: VMware Workstation, Oracle VirtualBox, Parallels Desktop
