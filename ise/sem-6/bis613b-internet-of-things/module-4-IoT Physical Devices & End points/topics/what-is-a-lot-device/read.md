...
- [Core Components of an IoT Device](#core-components-of-an-iot-device)
  - [1. Sensors and Actuators](#1-sensors-and-actuators)
  - [2. Microcontroller / Microprocessor (The Brain)](#2-microcontroller--microprocessor-the-brain)
  - [3. Connectivity Module](#3-connectivity-module)
  - [4. Power Supply](#4-power-supply)
  - [5. Input/Output (I/O) Interfaces](#5-inputoutput-io-interfaces)
- [Key Characteristics of IoT Devices](#key-characteristics-of-iot-devices)
- [Types of IoT Devices](#types-of-iot-devices)
- [Relationship to IoT Ecosystem](#relationship-to-iot-ecosystem)
- [Examples of IoT Devices](#examples-of-iot-devices)
- [Exam Tips](#exam-tips)
