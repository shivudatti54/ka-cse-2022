...
- [Substitution Ciphers: Caesar and Monoalphabetic](#substitution-ciphers-caesar-and-monoalphabetic)
- [1. Introduction to Classical Cryptography](#1-introduction-to-classical-cryptography)
- [2. The Core Concept: Substitution](#2-the-core-concept-substitution)
- [3. The Caesar Cipher](#3-the-caesar-cipher)
  - [3.1. How it Works](#31-how-it-works)
  - [3.2. Example](#32-example)
  - [3.3. Cryptanalysis of the Caesar Cipher](#33-cryptanalysis-of-the-caesar-cipher)
- [4. Monoalphabetic Substitution Cipher](#4-monoalphabetic-substitution-cipher)
  - [4.1. How it Works](#41-how-it-works)
  - [4.2. Keyspace and Theoretical Strength](#42-keyspace-and-theoretical-strength)
  - [4.3. Cryptanalysis using Frequency Analysis](#43-cryptanalysis-using-frequency-analysis)
- [5. Comparison of Ciphers](#5-comparison-of-ciphers)
- [6. Conclusion and Historical Context](#6-conclusion-and-historical-context)
- [Exam Tips](#exam-tips)
