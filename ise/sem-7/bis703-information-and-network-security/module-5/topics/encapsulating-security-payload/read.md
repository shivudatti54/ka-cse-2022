...
- [ESP Packet Structure](#esp-packet-structure)
  - [Header Format](#header-format)
  - [Trailer Format](#trailer-format)
- [Modes of Operation](#modes-of-operation)
  - [1. Transport Mode](#1-transport-mode)
  - [2. Tunnel Mode](#2-tunnel-mode)
- [Supported Algorithms](#supported-algorithms)
- [Internet Key Exchange (IKE) Integration](#internet-key-exchange-ike-integration)
- [Packet Processing Steps](#packet-processing-steps)
  - [Outbound Processing](#outbound-processing)
  - [Inbound Processing](#inbound-processing)
- [Examples](#examples)
  - [Example 1: ESP Transport Mode Configuration](#example-1-esp-transport-mode-configuration)
  - [Example 2: ESP Tunnel Mode VPN](#example-2-esp-tunnel-mode-vpn)
