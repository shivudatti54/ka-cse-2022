...
- [Properties of Cryptographic Hash Functions](#properties-of-cryptographic-hash-functions)
  - [1. Pre-image Resistance (One-Wayness)](#1-pre-image-resistance-one-wayness)
  - [2. Second Pre-image Resistance (Weak Collision Resistance)](#2-second-pre-image-resistance-weak-collision-resistance)
  - [3. Collision Resistance (Strong Collision Resistance)](#3-collision-resistance-strong-collision-resistance)
  - [4. Deterministic](#4-deterministic)
  - [5. Avalanche Effect](#5-avalanche-effect)
  - [6. Speed](#6-speed)
- [Structure of Hash Functions: The Merkle-Damgård Construction](#structure-of-hash-functions-the-merkle-damgrd-construction)
- [Common Hash Algorithms](#common-hash-algorithms)
- [Applications of Hash Functions](#applications-of-hash-functions)
  - [1. Data Integrity Verification](#1-data-integrity-verification)
  - [2. Password Storage](#2-password-storage)
  - [3. Digital Signatures](#3-digital-signatures)
  - [4. Blockchain and Cryptocurrency](#4-blockchain-and-cryptocurrency)
- [Hash Functions vs. Encryption](#hash-functions-vs-encryption)
- [Exam Tips](#exam-tips)
