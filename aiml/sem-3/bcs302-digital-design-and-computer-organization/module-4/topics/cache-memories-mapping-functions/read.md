...
- [Cache Memories – Mapping Functions](#cache-memories--mapping-functions)
- [Introduction](#introduction)
- [Cache Organization Fundamentals](#cache-organization-fundamentals)
- [1. Direct Mapping](#1-direct-mapping)
  - [Mapping Function Derivation](#mapping-function-derivation)
  - [Address Field Breakdown](#address-field-breakdown)
...
- [3. Set-Associative Mapping](#3-set-associative-mapping)
  - [Mapping Function Derivation](#mapping-function-derivation)
  - [Address Field Breakdown](#address-field-breakdown)
  - [Example: 2-Way Set-Associative Cache](#example-2-way-set-associative-cache)
  - [Advantages and Disadvantages](#advantages-and-disadvantages)
  - [Special Cases](#special-cases)
- [4. Replacement Policies](#4-replacement-policies)
  - [Least Recently Used (LRU)](#least-recently-used-lru)
  - [First In First Out (FIFO)](#first-in-first-out-fifo)
  - [Random](#random)
  - [Policy Comparison](#policy-comparison)
- [5. Performance Analysis and Comparison](#5-performance-analysis-and-comparison)
  - [Hit Rate Equations](#hit-rate-equations)
  - [Quantitative Comparison](#quantitative-comparison)
- [6. Solved Numerical Problem](#6-solved-numerical-problem)
