...
- [Addressing Modes in Instruction Set Architecture](#addressing-modes-in-instruction-set-architecture)
- [1. Introduction and Fundamentals](#1-introduction-and-fundamentals)
- [2. Classification of Addressing Modes](#2-classification-of-addressing-modes)
  - [2.1 Immediate Addressing Mode](#21-immediate-addressing-mode)
  - [2.2 Register Addressing Mode](#22-register-addressing-mode)
  - [2.3 Direct Addressing Mode (Absolute Addressing)](#23-direct-addressing-mode-absolute-addressing)
  - [2.4 Indirect Addressing Mode (Memory Indirect)](#24-indirect-addressing-mode-memory-indirect)
  - [2.5 Register Indirect Addressing Mode](#25-register-indirect-addressing-mode)
  - [2.6 Indexed Addressing Mode](#26-indexed-addressing-mode)
  - [2.7 Base-Register Addressing Mode](#27-base-register-addressing-mode)
  - [2.8 Relative Addressing Mode](#28-relative-addressing-mode)
  - [2.9 Stack Addressing Mode](#29-stack-addressing-mode)
- [3. Comparative Analysis of Addressing Modes](#3-comparative-analysis-of-addressing-modes)
...
- [5. Assessment Questions](#5-assessment-questions)
  ...
  - [Question 3 (Numerical)](#question-3-numerical)
