...
- [Performance Measurement in Computer Architecture](#performance-measurement-in-computer-architecture)
- [1. Introduction](#1-introduction)
- [2. Fundamental Performance Metrics](#2-fundamental-performance-metrics)
  - [2.1 Execution Time (Latency)](#21-execution-time-latency)
  - [2.2 Throughput (Bandwidth)](#22-throughput-bandwidth)
- [3. The CPU Performance Equation](#3-the-cpu-performance-equation)
  - [3.1 Derivation and Formulation](#31-derivation-and-formulation)
  - [3.2 Illustrative Example](#32-illustrative-example)
  - [3.3 Comparative Analysis](#33-comparative-analysis)
- [4. Alternative Performance Metrics](#4-alternative-performance-metrics)
  - [4.1 MIPS (Million Instructions Per Second)](#41-mips-million-instructions-per-second)
  - [4.2 MFLOPS (Million Floating-Point Operations Per Second)](#42-mflops-million-floating-point-operations-per-second)
- [5. Amdahl's Law: Theoretical Limits of Performance Enhancement](#5-amdahls-law-theoretical-limits-of-performance-enhancement)
  - [5.1 Statement and Derivation](#51-statement-and-derivation)
  - [5.2 Implications](#52-implications)
  - [5.3 Numerical Example](#53-numerical-example)
- [6. Benchmark Methodology](#6-benchmark-methodology)
  - [6.1 Definition and Classification](#61-definition-and-classification)
  - [6.2 SPEC Benchmark Suite](#62-spec-benchmark-suite)
- [7. Summary](#7-summary)
