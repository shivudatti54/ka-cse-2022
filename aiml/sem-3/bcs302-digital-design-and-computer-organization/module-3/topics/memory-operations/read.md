...
- [2. Fundamental Memory Operations](#2-fundamental-memory-operations)
  - [2.1 Read (Load) Operation](#21-read-load-operation)
  - [2.2 Write (Store) Operation](#22-write-store-operation)
- [3. Memory Organization and Register Transfer Notation](#3-memory-organization-and-register-transfer-notation)
  - [3.1 The Role of MAR and MDR](#31-the-role-of-mar-and-mdr)
  - [3.2 Extended Register Transfer Notation](#32-extended-register-transfer-notation)
- [4. Memory Access Time and Performance](#4-memory-access-time-and-performance)
  - [4.1 Definitions and Terminology](#41-definitions-and-terminology)
  - [4.2 Quantitative Analysis](#42-quantitative-analysis)
  - [4.3 Memory Hierarchy Performance](#43-memory-hierarchy-performance)
- [5. Data Organization in Memory](#5-data-organization-in-memory)
  - [5.1 Word Alignment](#51-word-alignment)
  - [5.2 Endianness](#52-endianness)
- [6. Memory Access During Instruction Execution](#6-memory-access-during-instruction-execution)
  - [6.1 Instruction Fetch-Execute Cycle](#61-instruction-fetch-execute-cycle)
  - [6.2 Example: Load Instruction](#62-example-load-instruction)
  - [6.3 Memory-Mapped I/O](#63-memory-mapped-io)
- [7. Summary](#7-summary)
