...
- [Fundamental Concepts of Basic Processing Unit and Pipelining](#fundamental-concepts-of-basic-processing-unit-and-pipelining)
- [Introduction](#introduction)
- [Key Concepts](#key-concepts)
  - [1. Processor Organization: Datapath and Control Unit](#1-processor-organization-datapath-and-control-unit)
  - [2. The Instruction Cycle](#2-the-instruction-cycle)
  - [3. Register Transfer Language (RTL)](#3-register-transfer-language-rtl)
  - [4. Basic Datapath Components](#4-basic-datapath-components)
  - [5. Control Signal Generation](#5-control-signal-generation)
  - [6. Introduction to Pipelining Concepts](#6-introduction-to-pipelining-concepts)
- [Examples](#examples)
  - [Example 1: RTL Description for ADD Instruction](#example-1-rtl-description-for-add-instruction)
  - [Example 2: Pipeline Timing Analysis](#example-2-pipeline-timing-analysis)
  - [Example 3: Control Signal Sequence for Load Instruction](#example-3-control-signal-sequence-for-load-instruction)
- [Exam Tips](#exam-tips)
