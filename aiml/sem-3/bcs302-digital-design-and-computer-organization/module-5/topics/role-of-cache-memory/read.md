...
- [Role of Cache Memory](#role-of-cache-memory)
- [Introduction](#introduction)
- [Theoretical Foundation: The Memory Wall Problem](#theoretical-foundation-the-memory-wall-problem)
  - [The Memory Hierarchy](#the-memory-hierarchy)
  - [Principle of Locality](#principle-of-locality)
- [Cache Organization and Functioning](#cache-organization-and-functioning)
  - [Cache Structure](#cache-structure)
  - [Cache Operation: Hit and Miss](#cache-operation-hit-and-miss)
  - [Performance Metrics](#performance-metrics)
- [Cache Mapping Techniques](#cache-mapping-techniques)
  - [1. Direct Mapping](#1-direct-mapping)
  - [2. Fully Associative Mapping](#2-fully-associative-mapping)
  - [3. Set Associative Mapping](#3-set-associative-mapping)
  - [Comparison of Mapping Techniques](#comparison-of-mapping-techniques)
- [Cache Replacement Policies](#cache-replacement-policies)
  - [Common Replacement Algorithms](#common-replacement-algorithms)
  - [Approximate LRU Implementations](#approximate-lru-implementations)
...
- [Multi-Level Cache Hierarchy](#multi-level-cache-hierarchy)
  - [L1 Cache (Primary Cache)](#l1-cache-primary-cache)
  - [L2 Cache (Secondary Cache)](#l2-cache-secondary-cache)
  - [L3 Cache (Tertiary Cache)](#l3-cache-tertiary-cache)
  - [Multi-Level Performance Analysis](#multi-level-performance-analysis)
  - [Inclusive vs. Exclusive Cache Hierarchies](#inclusive-vs-exclusive-cache-hierarchies)
- [Cache Coherence (Overview)](#cache-coherence-overview)
- [Summary](#summary)
