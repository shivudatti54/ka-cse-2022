...
- [Representation of Disjoint Sets](#representation-of-disjoint-sets)
- [1. Introduction and Theoretical Foundation](#1-introduction-and-theoretical-foundation)
- [2. Array-Based Representation (Forest Representation)](#2-array-based-representation-forest-representation)
  - [2.1 Data Structure Definition](#21-data-structure-definition)
  - [2.2 MakeSet Operation](#22-makeset-operation)
  - [2.3 Find Operation with Path Compression](#23-find-operation-with-path-compression)
  - [2.4 Union Operation with Union by Rank](#24-union-operation-with-union-by-rank)
- [3. Time Complexity Analysis](#3-time-complexity-analysis)
  - [3.1 Amortized Analysis](#31-amortized-analysis)
  - [3.2 Complexity Summary](#32-complexity-summary)
  - [3.3 Space Complexity](#33-space-complexity)
- [4. Linked List Representation](#4-linked-list-representation)
- [5. Comparative Analysis](#5-comparative-analysis)
- [6. Application: Kruskal's Minimum Spanning Tree Algorithm](#6-application-kruskals-minimum-spanning-tree-algorithm)
- [7. Additional Applications](#7-additional-applications)
- [8. Practice Problems](#8-practice-problems)
  - [Problem 1: Trace the Union-Find Operations](#problem-1-trace-the-union-find-operations)
  - [Problem 2: Time Complexity Analysis](#problem-2-time-complexity-analysis)
  - [Problem 3: Cycle Detection](#problem-3-cycle-detection)
