...
- [Theoretical Foundation](#theoretical-foundation)
  ...
  - [Formal Algorithm Specification](#formal-algorithm-specification)
  - [Correctness Proof: Shortest Path Property](#correctness-proof-shortest-path-property)
...
- [Step-by-Step Execution Trace](#step-by-step-execution-trace)
  ...
  - [Detailed Execution Trace Starting from Vertex 0](#detailed-execution-trace-starting-from-vertex-0)
  - [Level Partitioning](#level-partitioning)
  - [BFS Tree Structure](#bfs-tree-structure)
- [Implementation in C (Adjacency List)](#implementation-in-c-adjacency-list)
- [Applications of BFS](#applications-of-bfs)
  - [1. Shortest Path in Unweighted Graphs](#1-shortest-path-in-unweighted-graphs)
  - [2. Cycle Detection in Undirected Graphs](#2-cycle-detection-in-undirected-graphs)
  - [3. Bipartite Graph Checking](#3-bipartite-graph-checking)
- [BFS vs DFS: Comparative Analysis](#bfs-vs-dfs-comparative-analysis)
