...
- [Circular Queues: A Comprehensive Analysis](#circular-queues-a-comprehensive-analysis)
- [1. Introduction and Theoretical Foundation](#1-introduction-and-theoretical-foundation)
  ...
  - [1.2 The Circular Solution](#12-the-circular-solution)
- [2. Formal Definitions and Invariants](#2-formal-definitions-and-invariants)
  - [2.1 State Variables](#21-state-variables)
  - [2.2 Queue Invariants](#22-queue-invariants)
  - [2.3 Empty and Full State Detection](#23-empty-and-full-state-detection)
- [3. Algorithmic Specifications and Correctness Proofs](#3-algorithmic-specifications-and-correctness-proofs)
  - [3.1 Algorithm for ENQUEUE Operation](#31-algorithm-for-enqueue-operation)
  - [3.2 Algorithm for DEQUEUE Operation](#32-algorithm-for-dequeue-operation)
  - [3.3 Auxiliary Operations](#33-auxiliary-operations)
- [4. Complexity Analysis](#4-complexity-analysis)
  - [4.1 Time Complexity (Formal Analysis)](#41-time-complexity-formal-analysis)
  - [4.2 Space Complexity](#42-space-complexity)
  - [4.3 Comparative Analysis](#43-comparative-analysis)
- [5. Implementation Considerations](#5-implementation-considerations)
  - [5.1 Array-Based Implementation in C](#51-array-based-implementation-in-c)
  - [5.2 Linked-List Based Implementation](#52-linked-list-based-implementation)
- [6. Practical Applications](#6-practical-applications)
- [7. Advanced Considerations](#7-advanced-considerations)
  - [7.1 Dynamic Circular Queue](#71-dynamic-circular-queue)
  - [7.2 Multi-Producer Multi-Consumer Buffers](#72-multi-producer-multi-consumer-buffers)
