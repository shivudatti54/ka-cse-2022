...
- [Key Concepts](#key-concepts)
  - [Formal Definition and Mathematical Foundation](#formal-definition-and-mathematical-foundation)
  - [Recursive Implementations with Complexity Analysis](#recursive-implementations-with-complexity-analysis)
  - [Iterative Traversals Using Explicit Data Structures](#iterative-traversals-using-explicit-data-structures)
  - [Morris Traversal: O(1) Space Complexity](#morris-traversal-o1-space-complexity)
  - [Level-Order Traversal (Breadth-First Search)](#level-order-traversal-breadth-first-search)
- [Examples](#examples)
  - [Example 1: Trace Traversals on a Given Tree](#example-1-trace-traversals-on-a-given-tree)
  - [Example 2: Expression Tree Evaluation](#example-2-expression-tree-evaluation)
  - [Example 3: Finding Boundary of Binary Tree](#example-3-finding-boundary-of-binary-tree)
- [Exam Tips](#exam-tips)
