...
- [The Six Categories of System Calls](#the-six-categories-of-system-calls)
- [1. Process Control](#1-process-control)
  - [Key System Calls](#key-system-calls)
  - [How fork() and exec() Work Together](#how-fork-and-exec-work-together)
  - [Example: Process Control in C](#example-process-control-in-c)
  - [Windows Equivalents](#windows-equivalents)
- [2. File Management](#2-file-management)
  - [Key System Calls](#key-system-calls)
  - [File Operations Flow](#file-operations-flow)
  - [Example: File Operations in C](#example-file-operations-in-c)
  - [Windows Equivalents](#windows-equivalents)
- [3. Device Management](#3-device-management)
  - [Key System Calls](#key-system-calls)
  - [UNIX: Everything is a File](#unix-everything-is-a-file)
  - [Windows Equivalents](#windows-equivalents)
- [4. Information Maintenance](#4-information-maintenance)
  - [Key System Calls](#key-system-calls)
...
- [5. Communication](#5-communication)
  ...
  - [Key System Calls](#key-system-calls)
  - [Comparison: Message Passing vs Shared Memory](#comparison-message-passing-vs-shared-memory)
  - [Windows Equivalents](#windows-equivalents)
