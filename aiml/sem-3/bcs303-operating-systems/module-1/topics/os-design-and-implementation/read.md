...
- [Mechanisms vs Policies](#mechanisms-vs-policies)
  ...
  - [Why Separate Mechanism and Policy?](#why-separate-mechanism-and-policy)
  - [Examples](#examples)
  - [Policy Changes Over Time](#policy-changes-over-time)
- [Implementation Languages](#implementation-languages)
  - [Historical Perspective](#historical-perspective)
  - [Assembly Language](#assembly-language)
  - [High-Level Languages (C, C++)](#high-level-languages-c-c)
  - [The UNIX Story](#the-unix-story)
  - [Modern OS Implementation](#modern-os-implementation)
- [Summary](#summary)
- [Exam Tips](#exam-tips)
