...
- [Why System Calls Are Needed](#why-system-calls-are-needed)
- [How System Calls Work](#how-system-calls-work)
  - [Step-by-Step Process](#step-by-step-process)
  - [Detailed Flow Diagram](#detailed-flow-diagram)
- [API vs System Call vs System Call Interface](#api-vs-system-call-vs-system-call-interface)
  - [Application Programming Interface (API)](#application-programming-interface-api)
  - [Common APIs](#common-apis)
  - [System Call Interface](#system-call-interface)
- [System Call Parameter Passing](#system-call-parameter-passing)
  - [Method 1: Registers](#method-1-registers)
  - [Method 2: Block / Table in Memory](#method-2-block--table-in-memory)
  - [Method 3: Stack](#method-3-stack)
  - [Comparison of Parameter Passing Methods](#comparison-of-parameter-passing-methods)
- [Example: How read() System Call Works](#example-how-read-system-call-works)
  - [C Program Code](#c-program-code)
  - [Detailed Trace of read(fd, buffer, 50)](#detailed-trace-of-readfd-buffer-50)
- [System Call Numbers](#system-call-numbers)
  - [Example System Call Numbers (Linux x86)](#example-system-call-numbers-linux-x86)
- [Mode Switch: User Mode vs Kernel Mode](#mode-switch-user-mode-vs-kernel-mode)
- [Summary](#summary)
- [Exam Tips](#exam-tips)
