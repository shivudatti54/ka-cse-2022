...
- [Introduction to File System Implementation](#introduction-to-file-system-implementation)
...
- [Example: UNIX File System (Based on i-nodes)](#example-unix-file-system-based-on-i-nodes)
- [Comparison of Allocation Methods](#comparison-of-allocation-methods)
- [Exam Tips](#exam-tips)
