...
- [On-Disk Structures](#on-disk-structures)
  - [1. Boot Control Block (per volume)](#1-boot-control-block-per-volume)
  - [2. Volume Control Block (per volume)](#2-volume-control-block-per-volume)
  - [3. Directory Structure (per file system)](#3-directory-structure-per-file-system)
  - [4. Per-File FCB (one per file)](#4-per-file-fcb-one-per-file)
- [In-Memory Structures](#in-memory-structures)
  - [1. Mount Table](#1-mount-table)
  - [2. Directory Structure Cache](#2-directory-structure-cache)
  - [3. System-Wide Open File Table](#3-system-wide-open-file-table)
  - [4. Per-Process Open File Table](#4-per-process-open-file-table)
- [How File Operations Work Through the Layers](#how-file-operations-work-through-the-layers)
  - [File Open Operation](#file-open-operation)
  - [File Read Operation](#file-read-operation)
- [Comparison: UFS vs NTFS Terminology](#comparison-ufs-vs-ntfs-terminology)
