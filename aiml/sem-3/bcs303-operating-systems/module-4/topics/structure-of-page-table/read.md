...
- [The Problem with Flat Page Tables](#the-problem-with-flat-page-tables)
- [1. Hierarchical Page Tables](#1-hierarchical-page-tables)
  - [Two-Level Page Table](#two-level-page-table)
  - [Three-Level Page Table](#three-level-page-table)
- [2. Hashed Page Tables](#2-hashed-page-tables)
  - [Structure](#structure)
...
- [3. Inverted Page Table](#3-inverted-page-table)
  ...
  - [Improving Search Time](#improving-search-time)
- [Comparison of Page Table Structures](#comparison-of-page-table-structures)
- [TLB and Page Table Interaction](#tlb-and-page-table-interaction)
- [Summary](#summary)
- [Exam Tips](#exam-tips)
