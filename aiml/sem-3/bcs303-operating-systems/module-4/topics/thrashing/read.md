...
- [Thrashing in Operating Systems](#thrashing-in-operating-systems)
- [Introduction](#introduction)
- [Core Concepts](#core-concepts)
  - [1. The Cause: Locality and Page Faults](#1-the-cause-locality-and-page-faults)
  - [2. The Domino Effect: Thrashing](#2-the-domino-effect-thrashing)
  - [3. The Formal Relationship](#3-the-formal-relationship)
- [Example](#example)
