...
- [Introduction to Process Operations](#introduction-to-process-operations)
- [Key Concepts in Process Operations](#key-concepts-in-process-operations)
  - [1. Process Creation](#1-process-creation)
  - [2. Process Termination](#2-process-termination)
  - [3. Process Waiting and Synchronization](#3-process-waiting-and-synchronization)
  - [4. Interprocess Communication (IPC)](#4-interprocess-communication-ipc)
- [Comparison of Key Process Operations](#comparison-of-key-process-operations)
- [Process States and Operations](#process-states-and-operations)
- [Exam Tips](#exam-tips)
