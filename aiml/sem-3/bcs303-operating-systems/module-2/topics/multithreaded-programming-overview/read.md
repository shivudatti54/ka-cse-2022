...
- [Key Concepts](#key-concepts)
  - [Thread Definition and Structure](#thread-definition-and-structure)
...
- [Examples](#examples)
  - [Example 1: Basic Thread Creation (POSIX Threads)](#example-1-basic-thread-creation-posix-threads)
  - [Example 2: Thread Synchronization with Mutex](#example-2-thread-synchronization-with-mutex)
  - [Example 3: Producer-Consumer Problem](#example-3-producer-consumer-problem)
- [Exam Tips](#exam-tips)
