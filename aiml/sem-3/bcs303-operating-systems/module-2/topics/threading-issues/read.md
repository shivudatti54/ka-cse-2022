...
- [Threading Issues in Operating Systems](#threading-issues-in-operating-systems)
- [Introduction](#introduction)
- [Core Threading Issues](#core-threading-issues)
  - [1. The `fork()` and `exec()` System Calls](#1-the-fork-and-exec-system-calls)
  - [2. Thread Cancellation](#2-thread-cancellation)
  - [3. Signal Handling](#3-signal-handling)
  - [4. Thread Pools](#4-thread-pools)
  - [5. Thread-Specific Data (TSD)](#5-thread-specific-data-tsd)
  - [6. Scheduler Activations](#6-scheduler-activations)
