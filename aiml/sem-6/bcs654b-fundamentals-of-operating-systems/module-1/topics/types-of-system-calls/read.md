...
- [Key Concepts](#key-concepts)
  - [1. Process Control System Calls](#1-process-control-system-calls)
  - [2. File Management System Calls](#2-file-management-system-calls)
  - [3. Device Management System Calls](#3-device-management-system-calls)
  - [4. Information Maintenance System Calls](#4-information-maintenance-system-calls)
  - [5. Communication System Calls](#5-communication-system-calls)
  - [6. Protection System Calls](#6-protection-system-calls)
- [Examples](#examples)
  - [Example 1: Process Creation and Control](#example-1-process-creation-and-control)
  - [Example 2: File Management Operations](#example-2-file-management-operations)
  - [Example 3: Inter-Process Communication via Pipe](#example-3-inter-process-communication-via-pipe)
- [Exam Tips](#exam-tips)
