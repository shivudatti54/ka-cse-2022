...
- [System Calls and API](#system-calls-and-api)
- [1. Introduction: Bridging User and System](#1-introduction-bridging-user-and-system)
- [2. What is a System Call?](#2-what-is-a-system-call)
- [3. The System Call Mechanism: A Step-by-Step Process](#3-the-system-call-mechanism-a-step-by-step-process)
- [4. Categories of System Calls](#4-categories-of-system-calls)
- [5. Application Programming Interface (API) vs. System Call](#5-application-programming-interface-api-vs-system-call)
- [6. Common Examples](#6-common-examples)
- [The 'os.getpid()' function is a Python API call.](#the-osgetpid-function-is-a-python-api-call)
- [Under the hood, it uses the 'getpid' system call.](#under-the-hood-it-uses-the-getpid-system-call)
- [7. Why Are System Calls Important?](#7-why-are-system-calls-important)
