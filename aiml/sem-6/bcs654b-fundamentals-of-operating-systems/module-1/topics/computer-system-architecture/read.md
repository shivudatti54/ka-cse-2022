...
- [1. Basic Computer System Organization](#1-basic-computer-system-organization)
  - [1.1 Von Neumann Architecture](#11-von-neumann-architecture)
  - [1.2 Harvard Architecture](#12-harvard-architecture)
- [2. Computer System Components](#2-computer-system-components)
  - [2.1 Central Processing Unit (CPU)](#21-central-processing-unit-cpu)
  - [2.2 Memory Hierarchy](#22-memory-hierarchy)
  - [2.3 Input/Output (I/O) System](#23-inputoutput-io-system)
- [3. System Buses](#3-system-buses)
  - [3.1 Types of Buses](#31-types-of-buses)
- [4. Multiprocessor Systems](#4-multiprocessor-systems)
  - [4.1 Types of Multiprocessor Systems](#41-types-of-multiprocessor-systems)
  - [4.2 NUMA (Non-Uniform Memory Access)](#42-numa-non-uniform-memory-access)
- [5. Storage Structure](#5-storage-structure)
  - [5.1 Primary Storage (Main Memory)](#51-primary-storage-main-memory)
  - [5.2 Secondary Storage](#52-secondary-storage)
  - [5.3 Caching](#53-caching)
- [6. Interrupt Handling](#6-interrupt-handling)
  - [6.1 Interrupt Process](#61-interrupt-process)
  - [6.2 Types of Interrupts](#62-types-of-interrupts)
- [7. DMA (Direct Memory Access)](#7-dma-direct-memory-access)
- [8. Modern Architectural Trends](#8-modern-architectural-trends)
  - [8.1 Pipelining](#81-pipelining)
  - [8.2 Superscalar Architecture](#82-superscalar-architecture)
  - [8.3 RISC vs. CISC](#83-risc-vs-cisc)
- [9. Exam Tips and Key Takeaways](#9-exam-tips-and-key-takeaways)
