...
- [Examples](#examples)
  - [Example 1: Page Replacement (FIFO vs Optimal vs LRU)](#example-1-page-replacement-fifo-vs-optimal-vs-lru)
  - [Example 2: Effective Access Time Calculation](#example-2-effective-access-time-calculation)
