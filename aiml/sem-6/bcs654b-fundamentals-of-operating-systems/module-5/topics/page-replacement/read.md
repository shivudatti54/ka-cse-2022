...
- [Introduction to Page Replacement](#introduction-to-page-replacement)
- [Key Concepts and Algorithms](#key-concepts-and-algorithms)
  ...
  - [Clock (Second Chance)](#clock-second-chance)
- [Belady's Anomaly](#beladys-anomaly)
- [Performance Comparison](#performance-comparison)
- [Real-World Applications](#real-world-applications)
- [Worked Examples](#worked-examples)
  - [Example 1: FIFO with 4 Frames](#example-1-fifo-with-4-frames)
  - [Example 2: LRU with 3 Frames](#example-2-lru-with-3-frames)
- [Exam Tips](#exam-tips)
- [Memory Management Formulas](#memory-management-formulas)
