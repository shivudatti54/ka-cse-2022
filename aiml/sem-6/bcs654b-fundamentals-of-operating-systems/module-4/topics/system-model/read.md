...
- [1. Basic System Structure](#1-basic-system-structure)
  - [1.1 Layered Architecture](#11-layered-architecture)
  - [1.2 CPU Modes and Privilege Levels](#12-cpu-modes-and-privilege-levels)
- [2. Types of Operating System Models](#2-types-of-operating-system-models)
  - [2.1 Batch Processing Systems](#21-batch-processing-systems)
  - [2.2 Time-Sharing Systems](#22-time-sharing-systems)
  - [2.3 Real-Time Systems](#23-real-time-systems)
  - [2.4 Distributed Systems](#24-distributed-systems)
- [3. System Components](#3-system-components)
  - [3.1 Process Management](#31-process-management)
  - [3.2 Memory Management](#32-memory-management)
  - [3.3 File Management](#33-file-management)
  - [3.4 I/O Management](#34-io-management)
  - [3.5 Networking](#35-networking)
- [4. Operating System Architecture](#4-operating-system-architecture)
  - [4.1 Monolithic Architecture](#41-monolithic-architecture)
  - [4.2 Layered Architecture](#42-layered-architecture)
  - [4.3 Microkernel Architecture](#43-microkernel-architecture)
  - [4.4 Client-Server Architecture](#44-client-server-architecture)
- [5. System Call Implementation](#5-system-call-implementation)
  - [5.1 System Call Mechanism](#51-system-call-mechanism)
  - [5.2 Example: File Read System Call](#52-example-file-read-system-call)
- [6. Process Scheduling](#6-process-scheduling)
- [7. Synchronization and Deadlock](#7-synchronization-and-deadlock)
