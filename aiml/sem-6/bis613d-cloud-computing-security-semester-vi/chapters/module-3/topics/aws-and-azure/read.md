...
A critical concept for cloud developers is the **Shared Responsibility Model**. The cloud provider is responsible for the security *of* the cloud (the infrastructure), while the customer is responsible for security *in* the cloud (their data, access management, and application security). This directly impacts how you program and configure your services.
