...
To overcome the limitations of the three-tier model, cloud data centers overwhelmingly use a two-tier **spine-leaf** architecture, a form of a *Clos network*.
```
+-----------+    +-----------+    +-----------+
...
*   **Focus on Principles:** Understand *why* spine-leaf is better than three-tier for east-west traffic. It's about predictable latency and scalability.
