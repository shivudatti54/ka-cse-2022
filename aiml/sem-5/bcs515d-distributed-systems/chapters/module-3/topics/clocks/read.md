...
2.  **Logical Clocks:** These assign sequence numbers to events to capture the *logical ordering* or *causality* between them, without necessarily corresponding to real-time.
